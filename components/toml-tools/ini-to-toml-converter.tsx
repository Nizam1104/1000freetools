...
export default function IniToTomlConverter() {
  ...
  const convertToToml = () => {
    try {
      ...
      toast.success('Successfully converted INI to TOML')
    } catch (err) {
      toast.error('Conversion failed. Please check your INI input.')
    }
  }

  const parseIni = (ini: string): any => {
    const result: any = {}
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Label htmlFor="ini-input" className="text-base font-medium">INI Input</Label>

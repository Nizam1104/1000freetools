...
import { Copy, Check, Search, Info, Globe, BookOpen } from "lucide-react"
...
const EMOJI_MEANINGS: EmojiMeaning[] = [
  {
    ...
    platformVariations: { Apple: "😀", Google: "😀", Samsung: "😀", Microsoft: "😀" },
    relatedEmojis: ["😃", "😄", "😁", "😊"],
  },
  {
    emoji: "😂",
  ...
  },
  {
    ...
    platformVariations: { Apple: "❤️", Google: "❤️", Samsung: "❤️", Microsoft: "❤️" },
    relatedEmojis: ["💕", "💖", "💗", "💓"],
  },
  {
    emoji: "🔥",
  ...
  },
  {
    ...
    unicode: "U+1F60D",
    meaning: "A face with hearts for eyes, expressing love, adoration, or strong attraction.",
    usage: "Show love for someone or something, express admiration, or react to something beautiful.",
    platformVariations: { Apple: "😍", Google: "😍", Samsung: "😍", Microsoft: "😍" },
    relatedEmojis: ["🥰", "😘", "💕", "❤️"],
  },
  {
    ...
    name: "Star-Struck",
    unicode: "U+1F929",
    meaning: "A face with stars for eyes, representing being impressed, excited, or in awe.",
    usage: "Express amazement, excitement about meeting someone famous, or seeing something impressive.",
    platformVariations: { Apple: "🤩", Google: "🤩", Samsung: "🤩", Microsoft: "🤩" },
    relatedEmojis: ["😍", "🤯", "✨", "🌟"],
  },
  {
    ...
    unicode: "U+1F60E",
    meaning: "A cool face wearing sunglasses. Represents being cool, confident, or relaxed.",
    usage: "Show you're feeling cool, confident, or to indicate something is awesome.",
    platformVariations: { Apple: "😎", Google: "😎", Samsung: "😎", Microsoft: "😎" },
    relatedEmojis: ["🕶️", "🤙", "👌", "🔥"],
  },
  {
    ...
    name: "Partying Face",
    unicode: "U+1F973",
    meaning: "A face with a party hat and confetti, representing celebration and fun.",
    usage: "Celebrate birthdays, parties, achievements, or any festive occasion.",
    platformVariations: { Apple: "🥳", Google: "🥳", Samsung: "🥳", Microsoft: "🥳" },
    relatedEmojis: ["🎉", "🎊", "🎂", "🥂"],
  },
  {
    ...
    name: "Hugging Face",
    unicode: "U+1F917",
    meaning: "A smiling face with open hands, as if giving a hug.",
    usage: "Offer comfort, support, or express warmth and friendliness.",
    platformVariations: { Apple: "🤗", Google: "🤗", Samsung: "🤗", Microsoft: "🤗" },
    relatedEmojis: ["🤝", "💕", "🫂", "😊"],
  },
]

export default function EmojiTranslatorMeaning() {
  ...
  const translateText = useCallback(() => {
    const emojiMap: Record<string, string> = {
      "happy": "😀", "laugh": "😂", "love": "❤️", "heart": "❤️",
      "fire": "🔥", "hot": "🔥", "cool": "😎", "think": "🤔",
      "pray": "🙏", "thanks": "🙏", "dead": "💀", "sparkle": "✨",
      "perfect": "💯", "thumbs up": "👍", "approve": "👍", "clap": "👏",
      "praise": "🙌", "strong": "💪", "star": "⭐", "moon": "🌙",
      "sun": "☀️", "rainbow": "🌈", "cloud": "☁️", "wave": "🌊",
      "water": "💧", "flower": "🌸", "party": "🎉", "celebrate": "🎉",
      "gift": "🎁", "birthday": "🎂", "cake": "🎂", "christmas": "🎄",
      "halloween": "🎃", "pumpkin": "🎃", "balloon": "🎈", "target": "🎯",
    ...
    <div className="w-full max-w-5xl mx-auto space-y-6">
      ...
      {selectedEmoji && (
        <section className="space-y-4 rounded-lg border bg-background p-6">
          <div className="flex items-start justify-between">
            ...
            <Button variant="outline" size="sm" onClick={() => copyToClipboard(selectedEmoji.emoji, "emoji")}>
      ...
      <section className="space-y-3 rounded-lg border bg-muted/30 p-4">
        <div className="flex items-center gap-2">
          ...
          <Label className="text-base font-medium">Text to Emoji Translator</Label>
        </div>
        <Textarea
          value={inputText}
          onChange={(e) => setInputText(e.target.value)}
          placeholder="Type text to translate to emojis, e.g., 'I am happy and love pizza'"
        ...
        {translatedText && (
          <div className="flex items-center justify-between mt-2">
            <p className="text-2xl">{translatedText}</p>
            <Button variant="outline" size="sm" onClick={() => copyToClipboard(translatedText, "translated")}>
              {copied === "translated" ? <Check className="size-4 mr-1" /> : <Copy className="size-4 mr-1" />}
              Copy
            </Button>
          </div>
        )}

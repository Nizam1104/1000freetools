...
export default function FieldTypesDialog({ open, onOpenChange, onSelectFieldType }: FieldTypesDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] sm:max-w-[90vw] lg:max-w-[80vw] max-h-[90vh] sm:max-h-[85vh] flex flex-col p-4 sm:p-6">
        ...
        <div className="flex gap-4 overflow-hidden flex-1">
          ...
          <div className="w-36 sm:w-44 lg:w-48 flex-shrink-0 border-r pr-2 sm:pr-4 hidden md:block">
          ...
          <div className="flex flex-col gap-4 overflow-hidden flex-1 w-full">
            ...
            <ScrollArea className="flex-1 overflow-auto">
              <div className="space-y-4 pr-4">
                {(selectedCategory === null ? filteredCategories : filteredCategories.filter(c => c.category === selectedCategory)).map((category, index) => (

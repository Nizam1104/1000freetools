...
export const metadata: Metadata = {
  ...
  description: `Generate secure password policies for organizations. Set length, complexity, expiry, lockout rules. Free policy builder tool.`,
  alternates: {
    canonical: `https://1000freetools.com/password-tools/password-policy-generator`,
  },
};
...
export default function PasswordPolicyGeneratorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Organizational Password Policy Builder</h1>
      ...
      {/* TODO: add tool component for password-policy-generator */}

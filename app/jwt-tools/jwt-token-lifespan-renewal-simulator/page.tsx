...
export const metadata: Metadata = {
  ...
  description: `Simulate JWT token lifespan and renewal flow online. Visualize activation and expiration timelines for designing auth strategies.`,
  alternates: {
    canonical: `https://1000freetools.com/jwt-tools/jwt-token-lifespan-renewal-simulator`,
  },
};
...
export default function JwtTokenLifespanRenewalSimulatorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Simulate JWT Lifespan & Renewal Flow</h1>
      ...
      {/* TODO: add tool component for jwt-token-lifespan-renewal-simulator */}

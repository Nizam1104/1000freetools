...
export const metadata: Metadata = {
  ...
  description: `Scramble and obfuscate JWT tokens for testing. Tamper with signatures, alter claims, and create invalid tokens to test app security.`,
  alternates: {
    canonical: `https://1000freetools.com/jwt-tools/jwt-token-scrambler-obfuscator`,
  },
};
...
export default function JwtTokenScramblerObfuscatorPage() {
  return (

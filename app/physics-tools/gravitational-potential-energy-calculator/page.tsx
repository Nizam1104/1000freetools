...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://1000freetools.com/physics-tools/gravitational-potential-energy-calculator`,
  },
};
...
export default function GravitationalPotentialEnergyCalculatorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      {/* TODO: add tool component for gravitational-potential-energy-calculator */}

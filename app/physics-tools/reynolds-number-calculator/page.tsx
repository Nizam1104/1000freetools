...
export const metadata: Metadata = {
  ...
  description: `Free Reynolds number calculator for fluid dynamics. Input flow parameters to get Re and see if flow is laminar or turbulent. Engineering and physics.`,
  alternates: {
    canonical: `https://1000freetools.com/physics-tools/reynolds-number-calculator`,
  },
};
...
export default function ReynoldsNumberCalculatorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      {/* TODO: add tool component for reynolds-number-calculator */}

  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">SQL JOIN Types Visualizer with Examples</h1>
        <p className="text-muted-foreground">Understand SQL JOINs visually with interactive examples. See how INNER, LEFT, RIGHT, and FULL JOINs work with sample data and clear Venn diagram explanations.</p>
      </header>

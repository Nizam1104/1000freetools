  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">CSV to SQL INSERT Statement Converter</h1>
        <p className="text-muted-foreground">Convert CSV files into SQL INSERT statements quickly. Upload your CSV, map columns, and generate SQL code to import data into MySQL, PostgreSQL, or SQL Server.</p>
      </header>

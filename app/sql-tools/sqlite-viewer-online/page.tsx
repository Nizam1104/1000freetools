...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://1000freetools.com/sql-tools/sqlite-viewer-online`,
  },
};
  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Online SQLite Database Viewer & Explorer</h1>
        <p className="text-muted-foreground">Open and explore SQLite .db files directly in your browser. View tables, run queries, and export data without any installation. Perfect for quick inspections.</p>
      </header>

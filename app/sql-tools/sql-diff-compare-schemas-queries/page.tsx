...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://1000freetools.com/sql-tools/sql-diff-compare-schemas-queries`,
  },
};
  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">SQL Diff Tool - Compare & Find Differences</h1>
        <p className="text-muted-foreground">Compare two SQL scripts or database schemas to instantly see differences. This diff tool highlights changes in tables, columns, constraints, and queries, perfect for code reviews.</p>
      </header>

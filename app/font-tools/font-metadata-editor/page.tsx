...
export const metadata: Metadata = {
  ...
  description: `Edit font metadata like name, family, copyright. Fix font conflicts in design software. Free online editor for TTF, OTF files.`,
  alternates: {
    canonical: `https://1000freetools.com/font-tools/font-metadata-editor`,
  },
};
...
export default function FontMetadataEditorPage() {
  return (

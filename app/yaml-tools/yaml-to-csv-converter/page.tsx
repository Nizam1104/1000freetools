...
import { YamlToCsvConverter } from "@/components/yaml-tools/yaml-to-csv-converter";
...
export const metadata: Metadata = {
  ...
  description: `Convert YAML arrays to CSV format online. Flatten nested data, choose delimiters, and generate spreadsheet-ready files instantly. No registration required.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/yaml-to-csv-converter`,
  },
};
...
export default function YamlToCsvConverterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert YAML to CSV Online</h1>

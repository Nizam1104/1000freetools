...
export const metadata: Metadata = {
  ...
  description: `Prettify YAML with custom formatting rules. Free online tool to set indentation, line width, and quoting style for consistent YAML styling.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/yaml-prettifier-custom`,
  },
};
...
export default function YamlPrettifierCustomPage() {
  return (

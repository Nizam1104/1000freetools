...
export const metadata: Metadata = {
  ...
  description: `Compare and diff two YAML files online. See structural differences with color-coded highlights. Ignore whitespace changes. Free and instant.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/yaml-diff-checker`,
  },
};
...
export default function YamlDiffCheckerPage() {
  return (

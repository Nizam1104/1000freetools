...
import { YamlToHtmlTable } from "@/components/yaml-tools/yaml-to-html-table";
...
export const metadata: Metadata = {
  ...
  description: `Convert YAML data to HTML tables online. Generate styled, sortable, and responsive tables for web pages. Includes CSS and JavaScript options. Free tool.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/yaml-to-html-table`,
  },
};
...
export default function YamlToHtmlTablePage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert YAML to HTML Table</h1>

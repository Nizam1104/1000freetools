...
import { CsvToYamlConverter } from "@/components/yaml-tools/csv-to-yaml-converter";
...
export const metadata: Metadata = {
  ...
  description: `Convert CSV files to YAML format online. Use spreadsheet data to create structured YAML lists and mappings. Supports custom delimiters. Free tool.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/csv-to-yaml-converter`,
  },
};
...
export default function CsvToYamlConverterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert CSV to YAML Online</h1>

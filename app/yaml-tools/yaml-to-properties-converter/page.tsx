...
export const metadata: Metadata = {
  ...
  description: `Convert YAML to Java .properties format online. Flatten nested configs into dot-notation keys. Escape special characters. Free tool for Spring Boot configs.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/yaml-to-properties-converter`,
  },
};
...
export default function YamlToPropertiesConverterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert YAML to .properties File</h1>

...
import { YamlEditor } from "@/components/yaml-tools/yaml-editor";
import YamlEditorSeo from "@/components/seo-content/yaml-tools/yaml-editor";

export const metadata: Metadata = {
  title: `Online YAML Editor | Edit & Validate YAML in Browser`,
  description: `Edit YAML files online with syntax highlighting and live error detection. Includes formatting, find/replace, and download options. No installation needed.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/yaml-editor`,
  },
};

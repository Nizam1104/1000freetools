...
export const metadata: Metadata = {
  ...
  description: `Convert YAML arrays to Markdown tables online. Generate pipe tables with aligned columns for documentation. Free tool for developers and writers.`,
  alternates: {
    canonical: `https://1000freetools.com/yaml-tools/yaml-to-markdown-table`,
  },
};
...
export default function YamlToMarkdownTablePage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert YAML to Markdown Table</h1>
      ...
      {/* TODO: add tool component for yaml-to-markdown-table */}

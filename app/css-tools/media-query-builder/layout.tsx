...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/media-query-builder",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/media-query-builder">Media Query Builder</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

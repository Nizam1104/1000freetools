...
export const metadata: Metadata = {
  title: "CSS Background Noise Generator",
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/background-noise-generator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/background-noise-generator">Background Noise Generator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/border-radius-generator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/border-radius-generator">Border Radius Generator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "CSS Spacing Scale Generator",
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/css-spacing-scale-generator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/css-spacing-scale-generator">Css Spacing Scale Generator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

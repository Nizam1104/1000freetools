...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/fluid-space-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/fluid-space-calculator">Fluid Space Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

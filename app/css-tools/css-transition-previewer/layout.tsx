...
export const metadata: Metadata = {
  title: "CSS Transition Previewer",
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/css-transition-previewer",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/css-transition-previewer">Css Transition Previewer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

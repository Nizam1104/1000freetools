...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/viewport-unit-converter",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/viewport-unit-converter">Viewport Unit Converter</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

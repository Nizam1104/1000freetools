...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/css-tools/fluid-typography-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/css-tools/fluid-typography-calculator">Fluid Typography Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

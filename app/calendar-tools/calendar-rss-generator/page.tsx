...
export const metadata: Metadata = {
  ...
  description: `Free calendar RSS/ICS feed generator. Create a subscribable feed from your events. Compatible with Google Calendar, Outlook, and news readers.`,
  alternates: {
    canonical: `https://1000freetools.com/calendar-tools/calendar-rss-generator`,
  },
};
...
export default function CalendarRssGeneratorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Create an RSS Feed for Your Calendar Events</h1>
      ...
      {/* TODO: add tool component for calendar-rss-generator */}

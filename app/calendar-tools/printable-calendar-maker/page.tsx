...
export const metadata: Metadata = {
  ...
  description: `Create and print custom calendars. Design monthly, yearly, or weekly layouts, add holidays, and download as PDF. Free printable calendar generator.`,
  alternates: {
    canonical: `https://1000freetools.com/calendar-tools/printable-calendar-maker`,
  },
};
...
export default function PrintableCalendarMakerPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Create & Print Your Custom Calendar</h1>
      ...
      {/* TODO: add tool component for printable-calendar-maker */}

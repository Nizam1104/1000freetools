...
export const metadata: Metadata = {
  ...
  description: `Free payday calculator. Generate a list of pay dates for the year based on your pay frequency. Adjusts for weekends and holidays. Plan your budget.`,
  alternates: {
    canonical: `https://1000freetools.com/calendar-tools/payday-calculator`,
  },
};
...
export default function PaydayCalculatorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Calculate Your Payday Schedule</h1>
      ...
      {/* TODO: add tool component for payday-calculator */}

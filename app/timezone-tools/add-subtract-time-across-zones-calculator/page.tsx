...
export const metadata: Metadata = {
  ...
  description: `Add or subtract hours/minutes/days to any time in any time zone. Calculate future/past times and convert the result to another time zone instantly.`,
  alternates: {
    canonical: `https://1000freetools.com/timezone-tools/add-subtract-time-across-zones-calculator`,
  },
};
...
export default function AddSubtractTimeAcrossZonesCalculatorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <div className="mt-16">
        <AddSubtractTimeAcrossZonesCalculatorSeo />
      </div>

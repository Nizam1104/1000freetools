  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert XML Data to SQL INSERT Statements</h1>
        <p className="text-muted-foreground">Easily import your XML data into a database. This tool generates ready-to-run SQL INSERT commands, mapping XML elements directly to your table columns.</p>
      </header>

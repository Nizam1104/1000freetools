...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://1000freetools.com/typography-tools/ligature-generator`,
  },
};
  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">See typographic ligatures in action. Input text to visualize where fonts combine characters like 'fi' and 'fl' into single glyphs.</p>
      </header>

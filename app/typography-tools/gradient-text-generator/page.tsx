  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">Make stunning gradient text for your website or graphics. Choose colors and direction, preview instantly, and copy the CSS code.</p>
      </header>

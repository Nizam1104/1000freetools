  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">Find the perfect line height for your text to improve readability. Adjust the spacing between lines and see a live preview with CSS code.</p>
      </header>

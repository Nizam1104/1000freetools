...
const developerTools = [
    {
        ...
        toolLink: "/developer-tools/mock-data-generator",
    },
];
            ...
            <div className="min-h-screen max-w-6xl mx-auto">
                ...
                <section className="container mx-auto px-4 py-12">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                            Professional online developer tools that help you build applications faster and easier. No software installation required.
                        </p>
                    </div>
                </section>
                ...
                <section className="container mx-auto px-4 py-12">
                    <div className="prose max-w-4xl mx-auto">
                        <h2 className="text-2xl font-semibold mb-4">Simple Developer Tools for Everyone</h2>
                        <p className="text-muted-foreground mb-6">
                            Our developer tools are built for software engineers, web developers, and anyone who needs to streamline their workflow without complex setups. Everything runs in your browser, making it fast, private, and accessible from any device.
                        </p>

                        <h2 className="text-2xl font-semibold mb-4">How to Use</h2>
                        <p className="text-muted-foreground mb-6">
                            Choose a tool from the list above, input your requirements using the available options, and get your results instantly. It's that simple. No sign-up required, no API keys, completely free.
                        </p>

...
import AudioThumbnailGenerator from "@/components/audio-tools/audio-thumbnail-generator";
import AudioThumbnailGeneratorSEO from "@/components/seo-content/audio-tools/audio-thumbnail-generator";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Generate visual thumbnails for audio files showing waveform and metadata. Free online audio thumbnail generator for MP3, WAV, FLAC.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-thumbnail-generator",
  },
};
...
export default function AudioThumbnailGeneratorPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-thumbnail-generator">Audio Thumbnail Generator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Thumbnail Generator</h1>

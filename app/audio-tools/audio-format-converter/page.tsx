...
import AudioFormatConverter from "@/components/audio-tools/audio-format-converter";
import AudioFormatConverterSEO from "@/components/seo-content/audio-tools/audio-format-converter";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Convert audio files between MP3, WAV, FLAC, OGG, AAC and more formats instantly. Free online audio format converter with no quality loss.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-format-converter",
  },
};
...
export default function AudioFormatConverterPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-format-converter">Audio Format Converter</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Format Converter</h1>

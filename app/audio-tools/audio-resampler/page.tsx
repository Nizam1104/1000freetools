...
import AudioResampler from "@/components/audio-tools/audio-resampler";
import AudioResamplerSEO from "@/components/seo-content/audio-tools/audio-resampler";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Resample audio files to a new sample rate. Free online audio resampler for MP3, WAV, FLAC. Maintain quality while changing sample rate.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-resampler",
  },
};
...
export default function AudioResamplerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-resampler">Audio Resampler</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Resampler</h1>

...
import AudioGainAnalyzer from "@/components/audio-tools/audio-gain-analyzer";
import AudioGainAnalyzerSEO from "@/components/seo-content/audio-tools/audio-gain-analyzer";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Analyze gain levels across an audio file. Check for clipping, peaks, and dynamic range. Free online audio gain analyzer.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-gain-analyzer",
  },
};
...
export default function AudioGainAnalyzerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-gain-analyzer">Audio Gain Analyzer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Gain Analyzer</h1>

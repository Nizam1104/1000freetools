...
import AudioFrequencyAnalyzer from "@/components/audio-tools/audio-frequency-analyzer";
import AudioFrequencyAnalyzerSEO from "@/components/seo-content/audio-tools/audio-frequency-analyzer";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Visualize and analyze the frequency spectrum of audio files. Free online audio frequency analyzer for MP3, WAV, FLAC.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-frequency-analyzer",
  },
};
...
export default function AudioFrequencyAnalyzerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-frequency-analyzer">Audio Frequency Analyzer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Frequency Analyzer</h1>

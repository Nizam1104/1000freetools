...
import AudioWaveformGenerator from "@/components/audio-tools/audio-waveform-generator";
import AudioWaveformGeneratorSEO from "@/components/seo-content/audio-tools/audio-waveform-generator";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Generate a waveform image from any audio file online. Export waveform as PNG. Free online audio waveform generator for MP3, WAV, FLAC.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-waveform-generator",
  },
};
...
export default function AudioWaveformGeneratorPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-waveform-generator">Audio Waveform Generator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Waveform Generator</h1>

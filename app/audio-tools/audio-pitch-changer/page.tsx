...
import AudioPitchChanger from "@/components/audio-tools/audio-pitch-changer";
import AudioPitchChangerSEO from "@/components/seo-content/audio-tools/audio-pitch-changer";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Shift the pitch of audio files up or down in semitones without changing speed. Free online audio pitch shifter for MP3, WAV, FLAC.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-pitch-changer",
  },
};
...
export default function AudioPitchChangerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-pitch-changer">Audio Pitch Changer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Pitch Changer</h1>

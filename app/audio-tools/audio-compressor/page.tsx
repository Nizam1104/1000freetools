...
import AudioCompressor from "@/components/audio-tools/audio-compressor";
import AudioCompressorSEO from "@/components/seo-content/audio-tools/audio-compressor";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Reduce audio file size without major quality loss. Free online audio compressor for MP3, WAV, FLAC, OGG. Fast and easy.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-compressor",
  },
};
...
export default function AudioCompressorPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-compressor">Audio Compressor</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Compressor</h1>

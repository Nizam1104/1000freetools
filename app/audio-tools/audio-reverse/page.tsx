...
import AudioReverse from "@/components/audio-tools/audio-reverse";
import AudioReverseSEO from "@/components/seo-content/audio-tools/audio-reverse";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Reverse any audio file to play it backwards. Free online audio reverser for MP3, WAV, FLAC, OGG. Instant download.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-reverse",
  },
};
...
export default function AudioReversePage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-reverse">Audio Reverse</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Reverser</h1>

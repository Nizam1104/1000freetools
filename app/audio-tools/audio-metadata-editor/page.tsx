...
import AudioMetadataEditor from "@/components/audio-tools/audio-metadata-editor";
import AudioMetadataEditorSEO from "@/components/seo-content/audio-tools/audio-metadata-editor";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Edit audio metadata including title, artist, album, genre, and cover art. Free online ID3 tag editor for MP3, FLAC, OGG.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-metadata-editor",
  },
};
...
export default function AudioMetadataEditorPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-metadata-editor">Audio Metadata Editor</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Metadata Editor</h1>

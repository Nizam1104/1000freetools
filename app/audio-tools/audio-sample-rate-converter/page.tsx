...
import AudioSampleRateConverter from "@/components/audio-tools/audio-sample-rate-converter";
import AudioSampleRateConverterSEO from "@/components/seo-content/audio-tools/audio-sample-rate-converter";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Convert audio sample rate between 8kHz, 22kHz, 44.1kHz, 48kHz, 96kHz and more. Free online sample rate converter.",
  alternates: {
    canonical: "https://1000freetools.com/audio-tools/audio-sample-rate-converter",
  },
};
...
export default function AudioSampleRateConverterPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/audio-tools/audio-sample-rate-converter">Audio Sample Rate Converter</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Audio Sample Rate Converter</h1>

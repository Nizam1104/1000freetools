...
export const metadata: Metadata = {
  ...
  description: `Free confidence interval calculator for population mean and proportion. Input sample data and confidence level to get the interval and margin of error.`,
  alternates: {
    canonical: `https://1000freetools.com/statistics-tools/confidence-interval-calculator`,
  },
};
...
export default function ConfidenceIntervalCalculatorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      {/* TODO: add tool component for confidence-interval-calculator */}

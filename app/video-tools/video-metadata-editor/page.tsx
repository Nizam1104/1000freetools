...
import VideoMetadataEditor from "@/components/video-tools/video-metadata-editor";
import VideoMetadataEditorSEO from "@/components/seo-content/video-tools/video-metadata-editor";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Edit video file metadata including title, author, description, and tags. Free online video metadata editor for MP4, MOV, MKV.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-metadata-editor",
  },
};
...
export default function VideoMetadataEditorPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-metadata-editor">Video Metadata Editor</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Metadata Editor</h1>

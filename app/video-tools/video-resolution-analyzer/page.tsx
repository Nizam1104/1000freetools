...
import VideoResolutionAnalyzer from "@/components/video-tools/video-resolution-analyzer";
import VideoResolutionAnalyzerSEO from "@/components/seo-content/video-tools/video-resolution-analyzer";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Check the resolution, aspect ratio, and dimensions of any video file. Free online video resolution analyzer for MP4, MOV, AVI.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-resolution-analyzer",
  },
};
...
export default function VideoResolutionAnalyzerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-resolution-analyzer">Video Resolution Analyzer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Resolution Analyzer</h1>

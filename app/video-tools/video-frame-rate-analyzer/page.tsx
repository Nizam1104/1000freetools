...
import VideoFrameRateAnalyzer from "@/components/video-tools/video-frame-rate-analyzer";
import VideoFrameRateAnalyzerSEO from "@/components/seo-content/video-tools/video-frame-rate-analyzer";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Analyze the frame rate (FPS) of any video file. Free online video frame rate analyzer for MP4, MOV, AVI, MKV.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-frame-rate-analyzer",
  },
};
...
export default function VideoFrameRateAnalyzerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-frame-rate-analyzer">Video Frame Rate Analyzer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Frame Rate Analyzer</h1>
      ...
      <VideoFrameRateAnalyzer />

      <VideoFrameRateAnalyzerSEO />

...
import VideoSpeedChanger from "@/components/video-tools/video-speed-changer";
import VideoSpeedChangerSEO from "@/components/seo-content/video-tools/video-speed-changer";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Speed up or slow down video files online. Free video speed changer for MP4, MOV, AVI. Create slow motion or time-lapse effects.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-speed-changer",
  },
};
...
export default function VideoSpeedChangerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-speed-changer">Video Speed Changer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Speed Changer</h1>

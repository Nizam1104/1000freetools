...
import VideoFragmenter from "@/components/video-tools/video-fragmenter";
import VideoFragmenterSEO from "@/components/seo-content/video-tools/video-fragmenter";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Split video files into equal fragments or by duration. Free online video fragmenter for MP4, MOV, MKV. No installation needed.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-fragmenter",
  },
};
...
export default function VideoFragmenterPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-fragmenter">Video Fragmenter</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Fragmenter</h1>

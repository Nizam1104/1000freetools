...
import VideoFrameExtractor from "@/components/video-tools/video-frame-extractor";
import VideoFrameExtractorSEO from "@/components/seo-content/video-tools/video-frame-extractor";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Extract individual frames from video files at any timestamp. Free online video frame extractor for MP4, MOV, AVI. Download as PNG.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-frame-extractor",
  },
};
...
export default function VideoFrameExtractorPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-frame-extractor">Video Frame Extractor</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Frame Extractor</h1>

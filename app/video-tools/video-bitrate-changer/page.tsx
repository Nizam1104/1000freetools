...
import VideoBitrateChanger from "@/components/video-tools/video-bitrate-changer";
import VideoBitrateChangerSEO from "@/components/seo-content/video-tools/video-bitrate-changer";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Change video bitrate to reduce file size or improve quality. Free online video bitrate changer for MP4, MOV, MKV and more.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-bitrate-changer",
  },
};
...
export default function VideoBitrateChangerPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-bitrate-changer">Video Bitrate Changer</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Bitrate Changer</h1>

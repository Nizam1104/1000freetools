...
import VideoTrackRemover from "@/components/video-tools/video-track-remover";
import VideoTrackRemoverSEO from "@/components/seo-content/video-tools/video-track-remover";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const metadata: Metadata = {
  ...
  description: "Remove specific tracks from video files including audio, subtitle, or data tracks. Free online video track remover for MP4, MKV.",
  alternates: {
    canonical: "https://1000freetools.com/video-tools/video-track-remover",
  },
};
...
export default function VideoTrackRemoverPage() {
  return (
    <div className="flex flex-col gap-y-4 max-w-6xl">
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/video-tools/video-track-remover">Video Track Remover</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div>
        <h1 className="text-3xl font-bold mb-3">Video Track Remover</h1>

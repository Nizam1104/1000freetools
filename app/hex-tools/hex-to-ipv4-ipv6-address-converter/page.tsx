...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://1000freetools.com/hex-tools/hex-to-ipv4-ipv6-address-converter`,
  },
};
...
export default function HexToIpv4Ipv6AddressConverterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      {<HexToIpv4Ipv6AddressConverter />}
      {/* TODO: add seo component for hex-to-ipv4-ipv6-address-converter */}

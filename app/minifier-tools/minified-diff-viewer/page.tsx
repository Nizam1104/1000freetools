...
export const metadata: Metadata = {
  ...
  description: `Free diff viewer tool for minified code. Visually compare original and compressed HTML, CSS, or JS to see removed whitespace and comments, ensuring safe minification.`,
  alternates: {
    canonical: `https://1000freetools.com/minifier-tools/minified-diff-viewer`,
  },
};
...
export default function MinifiedDiffViewerPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Minified Code Diff Viewer</h1>

...
export const metadata: Metadata = {
  ...
  description: `Free WordPress minifier tool to compress theme and plugin files. Minify PHP, CSS, and JS in your WordPress project to boost site speed and performance.`,
  alternates: {
    canonical: `https://1000freetools.com/minifier-tools/wordpress-minifier`,
  },
};
...
export default function WordpressMinifierPage() {
  return (

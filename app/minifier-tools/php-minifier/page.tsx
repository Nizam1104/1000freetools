...
export const metadata: Metadata = {
  ...
  description: `Free PHP minifier tool to compress PHP source code by removing whitespace and comments. Optimize PHP files for faster execution and reduced bandwidth usage.`,
  alternates: {
    canonical: `https://1000freetools.com/minifier-tools/php-minifier`,
  },
};
...
export default function PhpMinifierPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">PHP Minifier & Code Compressor</h1>

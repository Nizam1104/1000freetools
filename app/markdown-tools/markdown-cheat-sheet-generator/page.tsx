...
export const metadata: Metadata = {
  ...
  description: `Create and print a custom Markdown cheat sheet. Choose syntax elements and download as PDF or text. Free tool.`,
  alternates: {
    canonical: `https://1000freetools.com/markdown-tools/markdown-cheat-sheet-generator`,
  },
};
...
export default function MarkdownCheatSheetGeneratorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <MarkdownCheatSheetGeneratorSeo />

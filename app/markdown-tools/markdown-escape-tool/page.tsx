...
export const metadata: Metadata = {
  ...
  description: `Escape or unescape Markdown special characters online. Prevent formatting interpretation for code and tutorials.`,
  alternates: {
    canonical: `https://1000freetools.com/markdown-tools/markdown-escape-tool`,
  },
};
...
export default function MarkdownEscapeToolPage() {
  return (

...
export const metadata: Metadata = {
  ...
  description: `Beautify and format code blocks in Markdown. Auto-detect language, fix indentation. Free online tool.`,
  alternates: {
    canonical: `https://1000freetools.com/markdown-tools/markdown-code-block-formatter`,
  },
};
...
export default function MarkdownCodeBlockFormatterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Markdown Code Block Beautifier</h1>

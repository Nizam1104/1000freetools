...
import { MarkdownToJiraConverter } from "@/components/markdown-tools/markdown-to-jira-converter";
...
export const metadata: Metadata = {
  ...
  description: `Convert Markdown to Jira Wiki markup online. Preview formatting for tickets and documentation. Free converter.`,
  alternates: {
    canonical: `https://1000freetools.com/markdown-tools/markdown-to-jira-converter`,
  },
};
...
export default function MarkdownToJiraConverterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert Markdown to Jira Wiki Markup</h1>

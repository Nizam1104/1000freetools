...
export const metadata: Metadata = {
  ...
  description: `Compare two Markdown files and see differences highlighted. Side-by-side and inline diff views. Free tool.`,
  alternates: {
    canonical: `https://1000freetools.com/markdown-tools/markdown-diff-checker`,
  },
};
...
export default function MarkdownDiffCheckerPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Compare and Diff Markdown Files</h1>
      ...
      {/* TODO: add tool component for markdown-diff-checker */}

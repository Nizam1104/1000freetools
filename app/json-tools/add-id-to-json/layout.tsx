...
export const metadata: Metadata = {
    title: "Add ID to JSON Array - Custom Ids to JSON array of objects",
    description: "Automatically add unique identifiers to each object in a JSON array. Choose from UUID, sequential numbers, random strings, custom patters, privacy focused",
    alternates: {
        canonical: "https://1000freetools.com/json-tools/add-id-to-json",
    },
};
            ...
            <div>
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/json-tools/add-id-to-json">Add Id To Json</BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>

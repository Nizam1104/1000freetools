    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mt-16 max-w-3xl">
          <h2 className="text-2xl font-semibold mb-4">About JSON Array Generator</h2>
          ...
          <div className="space-y-4 mb-8">
            <div>
              <p className="font-medium mb-1">What value types can I generate?</p>
              <p className="text-muted-foreground">Choose from Number (random integers), String (item_0 pattern), Boolean (random true/false), or Object (with id and value properties).</p>
            </div>
            <div>
              <p className="font-medium mb-1">How large can the array be?</p>
              <p className="text-muted-foreground">The maximum length is 1000 items. Larger arrays may slow down your browser, so keep it reasonable for testing purposes.</p>
            </div>
            <div>
              <p className="font-medium mb-1">Can I generate the same data twice?</p>
              <p className="text-muted-foreground">No, values are randomly generated each time. If you need reproducible data, copy the result and save it for reuse.</p>
            </div>
            <div>
              <p className="font-medium mb-1">How do I get the generated array?</p>
              <p className="text-muted-foreground">Use the Copy button to paste into your code, or Download to save as a JSON file. Both options are available after generation.</p>
            </div>
            <div>
              <p className="font-medium mb-1">Is this data suitable for production?</p>
              <p className="text-muted-foreground">No, this is for testing and development only. Production data should come from your actual database or API, not random generators.</p>
            </div>
          </div>

          <h3 className="text-xl font-semibold mb-3">Related tools</h3>
          <ul className="space-y-2 text-muted-foreground">
            <li><a href="/json-tools/json-nested-structure" className="text-primary hover:underline">JSON Nested Structure Generator</a> – Create deeply nested JSON</li>
            <li><a href="/json-tools/json-object-generator" className="text-primary hover:underline">JSON Object Generator</a> – Generate mock objects</li>
            <li><a href="/json-tools/json-array-object-counter" className="text-primary hover:underline">JSON Array & Object Counter</a> – Count elements in JSON</li>
          </ul>
        </div>
      </div>
    </div>

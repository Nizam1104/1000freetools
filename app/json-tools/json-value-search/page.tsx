...
import { FileJson, RotateCcw, Trash2, Search, Copy, Check, Filter } from "lucide-react";
...
export default function JsonValueSearchPage() {
  ...
  const searchJson = useCallback((obj: unknown, query: string, path = ""): SearchMatch[] => {
    if (obj === null || typeof obj !== "object") {
      ...
      const keyMatches = searchIn !== "values" && compareKey.includes(compareQuery);
      const valueMatches = searchIn !== "keys" && compareValue.includes(compareQuery);
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-semibold tracking-tight mb-2">JSON Search & Filter Tool Online</h1>
          ...
          <CardContent className="p-4 space-y-4">
            <div className="flex flex-wrap items-end gap-4">
              ...
              <div className="flex items-center gap-2">
                <Label htmlFor="searchIn" className="text-sm text-muted-foreground whitespace-nowrap">
                  Search In:
                </Label>
                <Select value={searchIn} onValueChange={(v) => setSearchIn(v as "both" | "keys" | "values")}>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="caseSensitive" className="text-sm text-muted-foreground cursor-pointer">
                    Case sensitive
                  </Label>
                </div>
              </div>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Select value={outputFormat} onValueChange={(v) => setOutputFormat(v as "json" | "table")}>
                      <SelectTrigger className="w-[120px]">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <Tabs value={outputFormat} onValueChange={(v) => setOutputFormat(v as "json" | "table")}>
                        ...
                        {filteredMatches.map((match, index) => (
                          ...
                          >
                            ...
                            <div className="p-3 text-sm font-mono truncate">
                              {highlightText(formatValue(match.value), searchQuery)}
                            </div>
                            <div className="p-3">
                              <span

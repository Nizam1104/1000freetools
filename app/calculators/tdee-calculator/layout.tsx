...
export const metadata: Metadata = {
  ...
  description: "Our TDEE calculator gives you a complete picture of your daily calorie burn. Factor in your activity level for an accurate estimate to guide weight loss, gain, or maintenance.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/tdee-calculator",
  },
};
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col gap-y-4">
        ...
        <h1 className="text-3xl font-bold mb-3">TDEE Calculator – Calculate Your Total Daily Energy Expenditure</h1>
        <p className="text-muted-foreground">Our TDEE calculator gives you a complete picture of your daily calorie burn. Factor in your activity level for an accurate estimate to guide weight loss, gain, or maintenance.</p>
      </header>
      {children}

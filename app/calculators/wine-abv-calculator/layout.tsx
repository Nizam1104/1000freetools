...
export const metadata: Metadata = {
  title: "Wine ABV Calculator – Calculate Alcohol Content in Homemade Wine",
  description: "Measure the strength of your homemade wine with our Wine ABV Calculator.            Use initial and final hydrometer gravity readings or Brix sugar levels to            calculate ABV percentage — perfect for home winemakers and fermentation enthusiasts.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/wine-abv-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/calculators/wine-abv-calculator">Wine Abv Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

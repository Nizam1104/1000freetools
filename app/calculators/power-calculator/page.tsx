        ...
        <Card className="mt-8">
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <a href="/calculators/energy-calculator" className="p-5 bg-muted rounded-lg hover:border-primary border transition-colors">
                <h3 className="font-semibold mb-2">Energy Calculator</h3>
                <p className="text-sm text-muted-foreground">Calculate kinetic and potential energy.</p>
              </a>
              ...
              <a href="/calculators/electrical-power-calculator" className="p-5 bg-muted rounded-lg hover:border-primary border transition-colors">
                <h3 className="font-semibold mb-2">Electrical Power Calculator</h3>
                <p className="text-sm text-muted-foreground">Calculate power from voltage and current.</p>
              </a>
            </div>
          </CardContent>
        </Card>

        ...
        <CardContent>
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <a href="/calculators/calorie-deficit-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
              ...
              <p className="text-xs text-muted-foreground">Plan your weight loss calories</p>
            </a>
            <a href="/calculators/macronutrient-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
              <p className="font-semibold text-sm">Macro Calculator</p>
              <p className="text-xs text-muted-foreground">Calculate protein, carbs, and fat</p>
            </a>
          </div>
        </CardContent>
      </Card>

...
export const metadata: Metadata = {
  title: "Reverse Stock Split Calculator",
  description: "Calculate the reduced share count and new price per share after a reverse stock split. Enter the consolidation ratio to see how your holdings are affected.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/reverse-stock-split-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/calculators/reverse-stock-split-calculator">Reverse Stock Split Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

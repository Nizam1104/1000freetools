...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/calculators/trapezoid-area-calculator",
  },
};
            ...
            <div>
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/calculators/trapezoid-area-calculator">Trapezoid Area Calculator</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Trapezoid Area Calculator</h1>
        <p className="text-muted-foreground">Calculate the area of a trapezoid</p>
      </header>
      {children}

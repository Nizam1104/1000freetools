...
export const metadata: Metadata = {
  ...
  description: "Calculate area and arc length of a circular sector",
  alternates: {
    canonical: "https://1000freetools.com/calculators/sector-area-calculator",
  },
};
            ...
            <div>
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/calculators/sector-area-calculator">Sector Area Calculator</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Sector Area Calculator</h1>
        <p className="text-muted-foreground">Calculate area and arc length of a circular sector</p>
      </header>
      {children}

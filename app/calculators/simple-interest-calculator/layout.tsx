...
export const metadata: Metadata = {
  ...
  description: "Calculate the interest earned or owed on a principal amount using the formula I = P × R × T. Enter your principal, annual rate, and time period to get instant results.",
  alternates: {
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/calculators/simple-interest-calculator">Simple Interest Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

        ...
        <Card className="mt-8">
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <a href="/calculators/half-life-calculator" className="p-5 bg-muted rounded-lg hover:border-primary border transition-colors">
                <h3 className="font-semibold mb-2">Half-Life Calculator</h3>
                <p className="text-sm text-muted-foreground">Calculate half-life from decay data.</p>
              </a>
              <a href="/calculators/arrhenius-equation-calculator" className="p-5 bg-muted rounded-lg hover:border-primary border transition-colors">
                <h3 className="font-semibold mb-2">Arrhenius Equation Calculator</h3>
                <p className="text-sm text-muted-foreground">Calculate activation energy from rate constants.</p>
              </a>
              <a href="/calculators/concentration-calculator" className="p-5 bg-muted rounded-lg hover:border-primary border transition-colors">
                <h3 className="font-semibold mb-2">Concentration Calculator</h3>
                <p className="text-sm text-muted-foreground">Calculate solution concentration and molarity.</p>
              </a>
            </div>
          </CardContent>
        </Card>

...
export const metadata: Metadata = {
  title: "Break-Even Discount Calculator",
  description: "Find the maximum discount you can offer without losing money. Calculate the break-even discount percentage given your cost price and current selling price.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/break-even-discount-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/calculators/break-even-discount-calculator">Break Even Discount Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Basketball Shooting Percentage Calculator – Calculate FG%, 3P% & FT%",
  description: "Analyze basketball shooting performance with our Shooting Percentage Calculator.            Calculate field goal percentage, three-point percentage, and free throw            percentage from shots made and attempted — essential stats for player            evaluation and game analysis.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/basketball-shooting-percentage-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/calculators/basketball-shooting-percentage-calculator">Basketball Shooting Percentage Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

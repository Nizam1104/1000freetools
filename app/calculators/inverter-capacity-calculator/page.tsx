        ...
        <CardContent>
          <div className="grid sm:grid-cols-3 gap-4">
            <a href="/calculators/electric-power-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
              ...
              <p className="text-xs text-muted-foreground">Calculate power and energy consumption</p>
            </a>
            <a href="/calculators/battery-life-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
              <p className="font-semibold text-sm">Battery Life Calculator</p>
              <p className="text-xs text-muted-foreground">Estimate battery runtime</p>
            </a>

...
export const metadata: Metadata = {
  ...
  description: "Estimate how many calories you burn on your bike rides. Our cycling calorie calculator factors in your weight, speed, and ride duration for accurate energy expenditure results.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/cycling-calorie-calculator",
  },
};

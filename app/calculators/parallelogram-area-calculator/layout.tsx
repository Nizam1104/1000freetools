...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/calculators/parallelogram-area-calculator",
  },
};
            ...
            <div>
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/calculators/parallelogram-area-calculator">Parallelogram Area Calculator</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Parallelogram Area Calculator</h1>
        <p className="text-muted-foreground">Calculate area and perimeter of a parallelogram</p>
      </header>
      {children}

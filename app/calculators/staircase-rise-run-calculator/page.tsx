        ...
        <CardContent>
          <div className="grid sm:grid-cols-3 gap-4">
            <a href="/calculators/concrete-volume-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
              ...
              <p className="text-xs text-muted-foreground">For stair footings</p>
            </a>
            <a href="/calculators/wood-board-feet-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
              ...
              <p className="text-xs text-muted-foreground">Calculate lumber needed</p>
            </a>
            <a href="/calculators/angle-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
              <p className="font-semibold text-sm">Angle Calculator</p>
              <p className="text-xs text-muted-foreground">Calculate stringer angles</p>
            </a>
          </div>
        </CardContent>
      </Card>

...
export const metadata: Metadata = {
  title: "Loot Drop Probability Calculator – Calculate Your Chances of Getting Rare Items",
  description: "Find out your real chances of getting that rare drop with our Loot Probability Calculator. Enter the item's drop rate and your number of attempts to calculate the probability of obtaining it — perfect for planning farming sessions in MMOs and ARPGs.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/loot-probability-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/calculators/loot-probability-calculator">Loot Probability Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

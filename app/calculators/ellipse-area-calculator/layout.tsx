...
export const metadata: Metadata = {
  ...
  description: "Calculate area and circumference of an ellipse",
  alternates: {
    canonical: "https://1000freetools.com/calculators/ellipse-area-calculator",
  },
};
            ...
            <div>
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/calculators/ellipse-area-calculator">Ellipse Area Calculator</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Ellipse Area Calculator</h1>
        <p className="text-muted-foreground">Calculate area and circumference of an ellipse</p>
      </header>
      {children}

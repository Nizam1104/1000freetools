...
export const metadata: Metadata = {
  title: "Volume of Pyramid Calculator",
  description: "Calculate volume of a rectangular pyramid",
  alternates: {
    canonical: "https://1000freetools.com/calculators/volume-of-pyramid-calculator",
  },
};
            ...
            <div>
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/calculators/volume-of-pyramid-calculator">Volume Of Pyramid Calculator</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Volume of Pyramid Calculator</h1>
        <p className="text-muted-foreground">Calculate volume of a rectangular pyramid</p>
      </header>
      {children}

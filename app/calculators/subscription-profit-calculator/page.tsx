          ...
          <Card>
            ...
            <CardContent>
              <div className="grid sm:grid-cols-3 gap-4">
                <a href="/calculators/subscription-pricing-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
                  <p className="font-semibold text-sm">Subscription Pricing Calculator</p>
                  <p className="text-xs text-muted-foreground">Optimize your pricing tiers</p>
                </a>
                <a href="/calculators/customer-lifetime-value-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
                  ...
                  <p className="text-xs text-muted-foreground">Calculate CLV and retention metrics</p>
                </a>
                <a href="/calculators/saas-churn-rate-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
                  <p className="font-semibold text-sm">SaaS Churn Rate Calculator</p>
                  <p className="text-xs text-muted-foreground">Analyze customer retention</p>
                </a>
              </div>
            </CardContent>
          </Card>

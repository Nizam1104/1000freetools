...
export const metadata: Metadata = {
  title: "Subscription Business Profit Calculator",
  description: "Analyze your subscription business's financials. Calculate MRR, ARR, churn impact, and profit given subscriber count, pricing, and operating costs.",
  alternates: {
    canonical: "https://1000freetools.com/calculators/subscription-profit-calculator",
  },
};
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/calculators/subscription-profit-calculator">Subscription Profit Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

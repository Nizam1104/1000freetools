...
export const metadata: Metadata = {
  ...
  description: `Format digits into US, UK, and international phone number formats. Validate numbers, extract from text, and create clickable call links.`,
  alternates: {
    canonical: `https://1000freetools.com/number-tools/phone-number-formatter`,
  },
};
...
export default function PhoneNumberFormatterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Format Digits into a Phone Number</h1>
      ...
      {/* TODO: add tool component for phone-number-formatter */}

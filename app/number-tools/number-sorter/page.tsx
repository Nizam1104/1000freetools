...
export const metadata: Metadata = {
  ...
  description: `Free tool to sort number lists, remove duplicates, and calculate statistics. Find min, max, sum, average, median, and mode of any number set.`,
  alternates: {
    canonical: `https://1000freetools.com/number-tools/number-sorter`,
  },
};

...
export const metadata: Metadata = {
  ...
  description: `Check if a number is a palindrome. Use the reverse-and-add algorithm to make non-palindromes into palindromes. Find palindrome numbers in a range.`,
  alternates: {
    canonical: `https://1000freetools.com/number-tools/palindrome-number-checker`,
  },
};
...
export default function PalindromeNumberCheckerPage() {
  return (

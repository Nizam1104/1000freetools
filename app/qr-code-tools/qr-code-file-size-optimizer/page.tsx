...
export const metadata: Metadata = {
  ...
  description: `Optimize and compress QR code images for web or print. Reduce PNG, JPG, SVG file size while keeping your QR code scannable. Free tool.`,
  alternates: {
    canonical: `https://1000freetools.com/qr-code-tools/qr-code-file-size-optimizer`,
  },
};
...
export default function QrCodeFileSizeOptimizerPage() {
  return (

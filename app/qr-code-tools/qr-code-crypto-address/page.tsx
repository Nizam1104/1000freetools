...
export const metadata: Metadata = {
  ...
  description: `Generate a QR code for cryptocurrency addresses. Supports Bitcoin, Ethereum, and others. Include amount and memo for easy payments.`,
  alternates: {
    canonical: `https://1000freetools.com/qr-code-tools/qr-code-crypto-address`,
  },
};
...
export default function QrCodeCryptoAddressPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Crypto Address QR Code Generator</h1>
      ...
      {/* TODO: add tool component for qr-code-crypto-address */}

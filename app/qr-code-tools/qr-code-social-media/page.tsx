...
export const metadata: Metadata = {
  ...
  description: `Generate a QR code linking to your social media. Connect to Instagram, TikTok, YouTube, etc. Grow your followers from offline materials.`,
  alternates: {
    canonical: `https://1000freetools.com/qr-code-tools/qr-code-social-media`,
  },
};
...
export default function QrCodeSocialMediaPage() {
  return (

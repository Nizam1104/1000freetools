...
export const metadata: Metadata = {
  ...
  description: `Generate a QR code for PayPal payments. Use your PayPal.Me link. Set a fixed amount for easy, scannable payment requests.`,
  alternates: {
    canonical: `https://1000freetools.com/qr-code-tools/qr-code-paypal`,
  },
};
...
export default function QrCodePaypalPage() {
  return (

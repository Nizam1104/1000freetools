...
export const metadata: Metadata = {
  ...
  description: `Generate a QR code for your restaurant's digital menu. Create a mobile-friendly menu page or link to a PDF. Contactless and easy to update.`,
  alternates: {
    canonical: `https://1000freetools.com/qr-code-tools/qr-code-restaurant-menu`,
  },
};
...
export default function QrCodeRestaurantMenuPage() {
  return (

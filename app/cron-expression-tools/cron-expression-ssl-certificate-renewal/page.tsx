...
export const metadata: Metadata = {
  ...
  description: `Generate CRON expressions to automate SSL certificate renewal checks. Schedule daily or weekly jobs for Certbot or similar tools. Free security tool.`,
  alternates: {
    canonical: `https://1000freetools.com/cron-expression-tools/cron-expression-ssl-certificate-renewal`,
  },
};
...
export default function CronExpressionSslCertificateRenewalPage() {
  return (

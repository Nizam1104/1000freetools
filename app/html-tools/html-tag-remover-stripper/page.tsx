...
export const metadata: Metadata = {
  title: `HTML Tag Remover | Strip HTML Tags Online`,
  description: `Remove HTML tags from text online. Strip all tags to get plain content, with options to preserve line breaks or keep specific tags.`,
  alternates: {
    canonical: `https://1000freetools.com/html-tools/html-tag-remover-stripper`,
  },
};
...
export default function HtmlTagRemoverStripperPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">
          Remove all HTML tags from your text to extract clean, plain content.
          This stripper handles nested tags and scripts, giving you just the
          readable text.
        </p>
      </header>
      <div className="mt-8">

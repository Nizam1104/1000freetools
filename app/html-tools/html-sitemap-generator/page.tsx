...
export const metadata: Metadata = {
  ...
  description: `Generate an HTML sitemap page from a list of URLs. Create a user-friendly link directory for your website with this free tool.`,
  alternates: {
    canonical: `https://1000freetools.com/html-tools/html-sitemap-generator`,
  },
};
...
export default function HtmlSitemapGeneratorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">
          Create an HTML sitemap page for your website quickly. Input your URLs,
          and this tool generates a clean, navigable list of links for your
          users.
        </p>
      </header>
      <div className="mt-8">

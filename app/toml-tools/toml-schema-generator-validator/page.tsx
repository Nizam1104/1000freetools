...
export const metadata: Metadata = {
  ...
  description: `Generate JSON Schema from TOML files or validate TOML against a schema. Ensure configuration consistency and data quality with this free online tool.`,
  alternates: {
    canonical: `https://1000freetools.com/toml-tools/toml-schema-generator-validator`,
  },
};
...
export default function TomlSchemaGeneratorValidatorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Generate and Validate TOML Schemas</h1>

...
export const metadata: Metadata = {
  ...
  description: `Generate random emojis with one click. Filter by category, spin a wheel, or create grids. Free tool for games and inspiration.`,
  alternates: {
    canonical: `https://1000freetools.com/emoji-tools/random-emoji-generator`,
  },
};

...
export const metadata: Metadata = {
  ...
  description: `Convert file system timestamps (Windows FILETIME, Mac OS time) to Unix timestamps and readable dates. Decode metadata timestamps online.`,
  alternates: {
    canonical: `https://1000freetools.com/timestamp-tools/file-timestamp-converter`,
  },
};
...
export default function FileTimestampConverterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      {/* TODO: add tool component for file-timestamp-converter */}

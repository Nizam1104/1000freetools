  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">SVG Metadata Viewer & Cleaner</h1>
        <p className="text-muted-foreground">See what hidden metadata is in your SVG files and remove it. Strip out editor information, comments, and other non-essential data to clean and shrink your SVG.</p>
      </header>

...
import JavascriptLinterCodeQualityChecker from "@/components/javascript-tools/javascript-linter-code-quality-checker";

export const metadata: Metadata = {
  title: `JavaScript Linter - Code Quality Checker Online`,
  description: `Free online JavaScript linter and code quality checker. Detect errors, style violations, and potential bugs with detailed feedback.`,
  alternates: {
    canonical: `https://1000freetools.com/javascript-tools/javascript-linter-code-quality-checker`,
  },
};
...
export default function JavascriptLinterCodeQualityCheckerPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">
          Lint and Check JavaScript Code Quality
        </h1>
        <p className="text-muted-foreground">
          Find errors, style issues, and potential bugs in your JavaScript code.
          Get actionable suggestions to improve code quality and
          maintainability.
        </p>
      </header>

...
export const metadata: Metadata = {
  ...
  description: `Free JavaScript diff checker to compare code snippets. Highlight line and character differences with syntax highlighting. Ignore whitespace changes.`,
  alternates: {
    canonical: `https://1000freetools.com/javascript-tools/javascript-diff-checker-comparator`,
  },
};
...
export default function JavascriptDiffCheckerComparatorPage() {
  return (

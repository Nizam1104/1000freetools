  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert Colors and Generate JavaScript Code</h1>
        <p className="text-muted-foreground">Convert between HEX, RGB, HSL, and named colors. Use the visual picker and get ready-to-use JavaScript color code snippets.</p>
      </header>

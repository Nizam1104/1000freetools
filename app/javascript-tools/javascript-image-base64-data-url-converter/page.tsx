  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Convert Images to Base64 Data URLs</h1>
        <p className="text-muted-foreground">Turn any image into a Base64 Data URL string for embedding directly in your HTML or CSS. No external image files needed.</p>
      </header>

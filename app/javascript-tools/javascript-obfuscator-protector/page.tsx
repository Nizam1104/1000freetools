  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Obfuscate JavaScript Code for Protection</h1>
        <p className="text-muted-foreground">Protect your JavaScript source code from theft and reverse engineering. Obfuscation transforms your code into a complex, unreadable format that still runs perfectly.</p>
      </header>

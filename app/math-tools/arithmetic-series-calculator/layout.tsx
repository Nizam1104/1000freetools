...
export const metadata: Metadata = {
  title: "Arithmetic Series Sum Calculator – Find Sum of AP Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/arithmetic-series-calculator",
  },
  openGraph: {
    title: "Arithmetic Series Sum Calculator – Find Sum of AP Online",
    description: "Calculate the sum of any arithmetic series with our free online calculator. Enter the first term, common difference, and number of terms to find the series sum instantly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/arithmetic-series-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/arithmetic-series-calculator">Arithmetic Series Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

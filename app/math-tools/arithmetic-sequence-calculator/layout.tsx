...
export const metadata: Metadata = {
  title: "Arithmetic Sequence Calculator – Find Terms & Sum Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/arithmetic-sequence-calculator",
  },
  openGraph: {
    title: "Arithmetic Sequence Calculator – Find Terms & Sum Online",
    description: "Calculate any term, common difference, or partial sum of an arithmetic sequence with our free online calculator. Enter known values to solve arithmetic progressions instantly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/arithmetic-sequence-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/arithmetic-sequence-calculator">Arithmetic Sequence Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

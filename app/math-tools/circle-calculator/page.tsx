...
export default function CircleCalculator() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Circle Calculator</CardTitle>
          <CardDescription>
            Enter one known value to calculate all other circle properties.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="ghost" size="sm" onClick={() => loadExample("radius", "7")}>
                r = 7
              </Button>
              <Button variant="ghost" size="sm" onClick={() => loadExample("diameter", "12")}>
                d = 12
              </Button>
              <Button variant="ghost" size="sm" onClick={() => loadExample("area", "100")}>
                A = 100
              </Button>
              <Button variant="ghost" size="sm" onClick={() => loadExample("circumference", "50")}>
                C = 50
              </Button>
            </div>
      ...
      <section className="space-y-6">
        <div>
          <h2 className="text-2xl font-semibold mb-3">Understanding Circle Properties</h2>
          <p className="text-muted-foreground">
      ...
      <section className="border-t pt-8 space-y-6">
        <h3 className="text-xl font-semibold">Circle Formulas</h3>
        
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border rounded-lg">
            <h4 className="font-semibold mb-3">Basic Relationships</h4>
          ...
          <div className="p-6 border rounded-lg">
            <h4 className="font-semibold mb-3">Circumference Formulas</h4>
            <div className="space-y-3">
              <div className="p-3 bg-muted rounded-lg">
                <div className="font-mono text-sm">C = 2πr</div>
          ...
          <div className="p-6 border rounded-lg">
            <h4 className="font-semibold mb-3">Area Formulas</h4>
            <div className="space-y-3">
              <div className="p-3 bg-muted rounded-lg">
                <div className="font-mono text-sm">A = πr²</div>
                <div className="text-xs text-muted-foreground mt-1">Using radius</div>
          ...
          <div className="p-6 border rounded-lg">
            <h4 className="font-semibold mb-3">Finding Radius from Other Properties</h4>
            <div className="space-y-3">
              <div className="p-3 bg-muted rounded-lg">
                <div className="font-mono text-sm">r = d/2</div>
      ...
      <section className="border-t pt-8 space-y-6">
        <h3 className="text-xl font-semibold">What Is Pi (π)?</h3>
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Why π Appears in Circle Formulas</h4>
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Pi Day</h4>
            <p className="text-sm text-muted-foreground">
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Example 1: Given Radius</h4>
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Example 2: Given Diameter</h4>
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Example 3: Given Area</h4>
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Example 4: Given Circumference</h4>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Wheels and Gears</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Pizza and Food</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Pipes and Flow Rate</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Circular Gardens and Lawns</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-semibold text-sm mb-2">Clocks and Angles</h4>
            <p className="text-sm text-muted-foreground">
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div className="space-y-6">
          <div>
            <h4 className="font-semibold text-sm mb-2">What is the formula for the area of a circle?</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-2">How do I find the circumference?</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-2">What's the difference between radius and diameter?</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-2">How do I find radius from area?</h4>
            <p className="text-sm text-muted-foreground">
              Rearrange A = πr² to get r = √(A/π). Take the square root of (area divided by π). For area 100, radius = √(100/π) ≈ √31.83 ≈ 5.64.
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-sm mb-2">Is circumference the same as perimeter?</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-2">Why is π used in circle formulas?</h4>
            <p className="text-sm text-muted-foreground">

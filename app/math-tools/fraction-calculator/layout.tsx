...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/fraction-calculator",
  },
  openGraph: {
    title: "Fraction Calculator – Add, Subtract, Multiply & Divide Fractions",
    description: "Easily add, subtract, multiply, and divide fractions with our free online fraction calculator. Get instant simplified results and step-by-step solutions for all fraction operations.",
    type: "website",
    url: "https://1000freetools.com/math-tools/fraction-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/fraction-calculator">Fraction Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

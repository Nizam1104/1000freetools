...
export const metadata: Metadata = {
  title: "Sales Tax & VAT Calculator – Compute Tax Amount Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/sales-tax-vat-calculator",
  },
  openGraph: {
    title: "Sales Tax & VAT Calculator – Compute Tax Amount Online",
    description: "Calculate sales tax or VAT on any purchase with our free online tax calculator. Enter price and tax rate to find the tax amount and total price including tax.",
    type: "website",
    url: "https://1000freetools.com/math-tools/sales-tax-vat-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/sales-tax-vat-calculator">Sales Tax Vat Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

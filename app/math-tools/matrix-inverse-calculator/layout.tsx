...
export const metadata: Metadata = {
  title: "Matrix Inverse Calculator – Find Inverse of Any Matrix",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/matrix-inverse-calculator",
  },
  openGraph: {
    title: "Matrix Inverse Calculator – Find Inverse of Any Matrix",
    description: "Find the inverse of any invertible square matrix with our free online matrix inverse calculator. Uses row reduction method with step-by-step solution for 2x2, 3x3, and larger matrices.",
    type: "website",
    url: "https://1000freetools.com/math-tools/matrix-inverse-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/matrix-inverse-calculator">Matrix Inverse Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

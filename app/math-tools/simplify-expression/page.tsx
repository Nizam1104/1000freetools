      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <a href="/math-tools/factor-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Factor expressions</p>
          </a>
          <a href="/math-tools/expanding-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            <p className="font-semibold text-sm">Expanding Calculator</p>
            <p className="text-xs text-muted-foreground">Expand brackets</p>
          </a>

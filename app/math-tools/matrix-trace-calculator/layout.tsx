...
export const metadata: Metadata = {
  title: "Matrix Trace Calculator – Find Trace of a Square Matrix",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/matrix-trace-calculator",
  },
  openGraph: {
    title: "Matrix Trace Calculator – Find Trace of a Square Matrix",
    description: "Calculate the trace of any square matrix instantly with our free online trace calculator. Sums the main diagonal elements with a clear formula and highlighted diagonal shown.",
    type: "website",
    url: "https://1000freetools.com/math-tools/matrix-trace-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/matrix-trace-calculator">Matrix Trace Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">Understanding Scatter Plots</h2>
        <p className="text-muted-foreground">
          A scatter plot displays individual data points on a two-dimensional grid, with one variable on the x-axis and another on the y-axis. It's the best way to visualize the relationship between two continuous variables.
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Positive Correlation</h3>
            <p className="text-sm text-muted-foreground">
              Points trend upward from left to right. As X increases, Y tends to increase. Example: height vs. weight.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Negative Correlation</h3>
            <p className="text-sm text-muted-foreground">
              Points trend downward from left to right. As X increases, Y tends to decrease. Example: speed vs. travel time.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">No Correlation</h3>
            <p className="text-sm text-muted-foreground">
              Points appear randomly scattered. No clear pattern between X and Y. Example: shoe size vs. IQ.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">What does a scatter plot show?</h3>
          <p className="text-sm text-muted-foreground">
            A scatter plot shows the relationship between two variables. Each point represents one observation with its X and Y values. Patterns in the points reveal correlations, clusters, or outliers.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What is the regression line?</h3>
          <p className="text-sm text-muted-foreground">
            The regression line (line of best fit) is the straight line that minimizes the distance to all points. It summarizes the overall trend and can be used for predictions.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do I identify outliers?</h3>
          <p className="text-sm text-muted-foreground">
            Outliers are points that fall far from the main cluster or the regression line. They might indicate data entry errors, unusual cases, or important exceptions worth investigating.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">When should I use a scatter plot?</h3>
          <p className="text-sm text-muted-foreground">
            Use scatter plots when you want to explore relationships between two continuous variables. They're essential for correlation analysis, regression, and identifying patterns before statistical modeling.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can scatter plots show causation?</h3>
          <p className="text-sm text-muted-foreground">
            No. A scatter plot can show correlation (association), but correlation doesn't prove causation. Two variables might be correlated due to a third factor, coincidence, or reverse causation.
          </p>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <a href="/math-tools/correlation-coefficient-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Calculate Pearson r</p>
          </a>
          <a href="/math-tools/linear-regression-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Best fit equation</p>
          </a>

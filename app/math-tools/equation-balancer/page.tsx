  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">Understanding Chemical Equations</h2>
        <p className="text-muted-foreground">
          A chemical equation represents a chemical reaction, showing reactants transforming into products. Balancing ensures the same number of atoms of each element on both sides, following the law of conservation of mass.
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Reactants</h3>
            <p className="text-sm text-muted-foreground">
              Starting substances on the left side of the arrow. These are consumed during the reaction.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Products</h3>
            <p className="text-sm text-muted-foreground">
              Substances formed on the right side of the arrow. These are produced by the reaction.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Coefficients</h3>
            <p className="text-sm text-muted-foreground">
              Numbers placed before formulas to balance the equation. They represent mole ratios.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">Why balance chemical equations?</h3>
          <p className="text-sm text-muted-foreground">
            Balancing ensures the law of conservation of mass is satisfied. Atoms cannot be created or destroyed, so the same number of each type must appear on both sides.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do I balance an equation?</h3>
          <p className="text-sm text-muted-foreground">
            1) Count atoms of each element on both sides. 2) Add coefficients to balance one element at a time. 3) Start with elements that appear once per side. 4) Check and adjust until balanced.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can I change subscripts to balance?</h3>
          <p className="text-sm text-muted-foreground">
            No! Subscripts define the chemical formula and cannot be changed. Only coefficients (numbers in front) can be adjusted to balance equations.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What do coefficients represent?</h3>
          <p className="text-sm text-muted-foreground">
            Coefficients represent the mole ratio of reactants and products. For example, 2H₂ + O₂ → 2H₂O means 2 moles of hydrogen react with 1 mole of oxygen.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What types of reactions can be balanced?</h3>
          <p className="text-sm text-muted-foreground">
            All types: synthesis, decomposition, single replacement, double replacement, combustion, and acid-base reactions can all be balanced using this tool.
          </p>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <a href="/math-tools/ratio-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Mole ratios</p>
          </a>
          <a href="/math-tools/percentage-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Percent composition</p>
          </a>

...
export const metadata: Metadata = {
  title: "Antilogarithm Calculator – Find Antilog of Any Number",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/antilogarithm-calculator",
  },
  openGraph: {
    title: "Antilogarithm Calculator – Find Antilog of Any Number",
    description: "Calculate the antilogarithm of any value for any base with our free online antilog calculator. Find the inverse of log base 10, natural log, or any custom base instantly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/antilogarithm-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/antilogarithm-calculator">Antilogarithm Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

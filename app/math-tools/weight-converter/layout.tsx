...
export const metadata: Metadata = {
  title: "Weight Converter – Convert kg, lbs, grams, oz Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/weight-converter",
  },
  openGraph: {
    title: "Weight Converter – Convert kg, lbs, grams, oz Online",
    description: "Convert between any weight or mass unit with our free online weight converter. Supports kilograms, pounds, grams, ounces, stones, metric tons, and more instantly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/weight-converter",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/weight-converter">Weight Converter</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Modular Arithmetic Calculator – Compute mod n Operations",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/modular-arithmetic-calculator",
  },
  openGraph: {
    title: "Modular Arithmetic Calculator – Compute mod n Operations",
    description: "Perform modular arithmetic operations including addition, subtraction, multiplication, and exponentiation under any modulus with our free online calculator.",
    type: "website",
    url: "https://1000freetools.com/math-tools/modular-arithmetic-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/modular-arithmetic-calculator">Modular Arithmetic Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          The binomial theorem provides a formula for expanding expressions of the form (a+b)^n. Instead of multiplying the binomial by itself n times, we can use binomial coefficients to find each term directly.
        </p>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Binomial Theorem</h3>
            <code className="text-sm font-mono bg-background px-2 py-1 rounded block">
              (a + b)^n = Σ C(n,k) × a^(n-k) × b^k
            </code>
            <p className="text-xs text-muted-foreground mt-2">
              Sum from k=0 to n, where C(n,k) is the binomial coefficient.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Binomial Coefficient</h3>
            <code className="text-sm font-mono bg-background px-2 py-1 rounded block">
              C(n,k) = n! / (k! × (n-k)!)
            </code>
            <p className="text-xs text-muted-foreground mt-2">
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">Pascal's Triangle</h2>
        <p className="text-muted-foreground">
          Pascal's Triangle is a triangular array where each number is the sum of the two numbers directly above it. Each row corresponds to the binomial coefficients for a specific power n.
        </p>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">What is binomial expansion?</h3>
          <p className="text-sm text-muted-foreground">
            Binomial expansion is the process of expanding (a+b)^n into a sum of terms. Each term has a binomial coefficient multiplied by powers of a and b.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How many terms are in the expansion?</h3>
          <p className="text-sm text-muted-foreground">
            The expansion of (a+b)^n has exactly n+1 terms. For example, (a+b)³ has 4 terms.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What are binomial coefficients?</h3>
          <p className="text-sm text-muted-foreground">
            Binomial coefficients C(n,k) represent the number of ways to choose k items from n items. They appear in Pascal's Triangle and determine the coefficient of each term.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can n be negative or fractional?</h3>
          <p className="text-sm text-muted-foreground">
            Yes, but the expansion becomes an infinite series (binomial series) rather than a finite sum. This calculator handles non-negative integer powers only.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Where is binomial expansion used?</h3>
          <p className="text-sm text-muted-foreground">
            It's used in probability (binomial distribution), algebra, calculus (Taylor series), combinatorics, and physics (approximations).
          </p>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          <a href="/math-tools/pascals-triangle-generator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            <p className="font-semibold text-sm">Pascal's Triangle</p>
            <p className="text-xs text-muted-foreground">Generate triangle</p>
          </a>
        </div>
      </section>
    </div>

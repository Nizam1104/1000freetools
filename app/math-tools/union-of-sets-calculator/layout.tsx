...
export const metadata: Metadata = {
  title: "Union of Sets Calculator – Find A ∪ B Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/union-of-sets-calculator",
  },
  openGraph: {
    title: "Union of Sets Calculator – Find A ∪ B Online",
    description: "Calculate the union of any two or more sets with our free online union calculator. Returns all unique elements combined from each set with clear set notation.",
    type: "website",
    url: "https://1000freetools.com/math-tools/union-of-sets-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/union-of-sets-calculator">Union Of Sets Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

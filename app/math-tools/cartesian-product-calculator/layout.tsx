...
export const metadata: Metadata = {
  title: "Cartesian Product Calculator – Find A × B Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/cartesian-product-calculator",
  },
  openGraph: {
    title: "Cartesian Product Calculator – Find A × B Online",
    description: "Calculate the Cartesian product of any two sets with our free online calculator. Lists all ordered pairs in A × B for set theory, relations, and combinatorics applications.",
    type: "website",
    url: "https://1000freetools.com/math-tools/cartesian-product-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/cartesian-product-calculator">Cartesian Product Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

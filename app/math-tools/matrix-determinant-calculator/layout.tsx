...
export const metadata: Metadata = {
  title: "Matrix Determinant Calculator – Compute Det of Any Matrix",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/matrix-determinant-calculator",
  },
  openGraph: {
    title: "Matrix Determinant Calculator – Compute Det of Any Matrix",
    description: "Calculate the determinant of any square matrix with our free online determinant calculator. Supports 2x2, 3x3, and larger matrices with cofactor expansion steps shown.",
    type: "website",
    url: "https://1000freetools.com/math-tools/matrix-determinant-calculator",
...
const tools = [
  ...
  {
    "name": "Eigenvalue Calculator – Find Eigenvalues of 2x2 & 3x3 Matrices",
    "description": "Calculate eigenvalues of 2x2 and 3x3 matrices with our free online eigenvalue calculator. Solves the characteristic polynomial with step-by-step solutions and complex eigenvalue support.",
    "href": "/math-tools/eigenvalue-calculator"
  },
  {
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/matrix-determinant-calculator">Matrix Determinant Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

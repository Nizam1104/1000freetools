  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">Sudoku Rules</h2>
        <p className="text-muted-foreground">
          Sudoku is a logic-based number puzzle. The goal is to fill a 9×9 grid with digits so that each column, each row, and each of the nine 3×3 subgrids contain all digits from 1 to 9.
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Row Rule</h3>
            <p className="text-sm text-muted-foreground">
              Each row must contain the digits 1-9 exactly once, with no repeats.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Column Rule</h3>
            <p className="text-sm text-muted-foreground">
              Each column must contain the digits 1-9 exactly once, with no repeats.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Box Rule</h3>
            <p className="text-sm text-muted-foreground">
              Each 3×3 box must contain the digits 1-9 exactly once, with no repeats.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">How do I play Sudoku?</h3>
          <p className="text-sm text-muted-foreground">
            Fill the 9×9 grid so each row, column, and 3×3 box contains 1-9. Start with obvious placements, then use elimination to find where numbers can go.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What makes a Sudoku valid?</h3>
          <p className="text-sm text-muted-foreground">
            A valid Sudoku has no duplicate numbers in any row, column, or 3×3 box. A complete valid Sudoku has all 81 cells filled correctly.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can Sudoku have multiple solutions?</h3>
          <p className="text-sm text-muted-foreground">
            Well-designed Sudoku puzzles have exactly one unique solution. Poorly constructed puzzles may have multiple solutions or no solution.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What's the minimum number of clues?</h3>
          <p className="text-sm text-muted-foreground">
            The minimum number of given clues for a valid Sudoku is 17. Puzzles with fewer clues either have multiple solutions or no solution.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do I check my progress?</h3>
          <p className="text-sm text-muted-foreground">
            Use this validator to check for errors as you go. It will highlight duplicate numbers and show which rows, columns, and boxes are incomplete.
          </p>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <a href="/math-tools/magic-square-generator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            <p className="font-semibold text-sm">Magic Square Generator</p>
            <p className="text-xs text-muted-foreground">Number puzzles</p>
          </a>
          <a href="/math-tools/number-sorter" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Sort numbers</p>
          </a>
          <a href="/math-tools/combinatio n-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            <p className="font-semibold text-sm">Combination Calculator</p>
            <p className="text-xs text-muted-foreground">Combinatorics</p>
          </a>
        </div>
      </section>
    </div>

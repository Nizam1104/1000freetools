...
export const metadata: Metadata = {
  title: "Logic Gate Simulator – Simulate AND OR NOT Gates Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/logic-gate-simulator",
  },
  openGraph: {
    title: "Logic Gate Simulator – Simulate AND OR NOT Gates Online",
    description: "Simulate any combination of digital logic gates with our free online logic gate simulator. Set input values and see real-time output for AND, OR, NOT, NAND, NOR, and XOR gates.",
    type: "website",
    url: "https://1000freetools.com/math-tools/logic-gate-simulator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/logic-gate-simulator">Logic Gate Simulator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

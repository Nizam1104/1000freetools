...
export const metadata: Metadata = {
  title: "Two's Complement Calculator – Convert to Twos Complement",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/twos-complement-calculator",
  },
  openGraph: {
    title: "Two's Complement Calculator – Convert to Twos Complement",
    description: "Convert any integer to its two's complement binary form or decode two's complement back to decimal with our free online calculator. Supports various bit widths.",
    type: "website",
    url: "https://1000freetools.com/math-tools/twos-complement-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/twos-complement-calculator">Twos Complement Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          A number line is a visual representation of numbers as points on a straight line. It helps understand the order of numbers, compare values, visualize operations like addition and subtraction, and understand concepts like negative numbers and absolute value.
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Positive Numbers</h3>
            <p className="text-sm text-muted-foreground">
              Located to the right of zero. Values increase as you move right.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Negative Numbers</h3>
            <p className="text-sm text-muted-foreground">
              Located to the left of zero. Values decrease as you move left.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Zero</h3>
            <p className="text-sm text-muted-foreground">
              The origin point. Separates positive and negative numbers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">What is a number line?</h3>
          <p className="text-sm text-muted-foreground">
            A number line is a straight line with numbers placed at equal intervals. It extends infinitely in both directions and helps visualize the relative positions of numbers.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do you compare numbers on a number line?</h3>
          <p className="text-sm text-muted-foreground">
            Numbers to the right are always greater than numbers to the left. For example, -2 is greater than -5 because -2 is to the right of -5.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can number lines show fractions and decimals?</h3>
          <p className="text-sm text-muted-foreground">
            Yes! Number lines can represent any real number, including fractions, decimals, and irrational numbers. They're placed proportionally between integers.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do you add using a number line?</h3>
          <p className="text-sm text-muted-foreground">
            Start at the first number, then move right for positive addends or left for negative addends. The endpoint is the sum.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What is absolute value on a number line?</h3>
          <p className="text-sm text-muted-foreground">
            Absolute value is the distance from zero, regardless of direction. Both -5 and 5 have an absolute value of 5 because they're both 5 units from zero.
          </p>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <a href="/math-tools/coordinate-plane-plotter" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            <p className="font-semibold text-sm">Coordinate Plane</p>
            <p className="text-xs text-muted-foreground">2D plotting</p>
          </a>

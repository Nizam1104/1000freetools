...
export const metadata: Metadata = {
  title: "Leap Year Checker – Is It a Leap Year? Find Out Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/leap-year-checker",
  },
  openGraph: {
    title: "Leap Year Checker – Is It a Leap Year? Find Out Online",
    description: "Check if any year is a leap year with our free online leap year checker. Instantly verify using Gregorian calendar rules with a clear explanation of why it is or isn't a leap year.",
    type: "website",
    url: "https://1000freetools.com/math-tools/leap-year-checker",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/leap-year-checker">Leap Year Checker</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

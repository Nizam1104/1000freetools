...
export const metadata: Metadata = {
  title: "Eigenvalue Calculator – Find Eigenvalues of 2x2 & 3x3 Matrices",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/eigenvalue-calculator",
  },
  openGraph: {
    title: "Eigenvalue Calculator – Find Eigenvalues of 2x2 & 3x3 Matrices",
    description: "Calculate eigenvalues of 2x2 and 3x3 matrices with our free online eigenvalue calculator. Solves the characteristic polynomial with step-by-step solutions and complex eigenvalue support.",
    type: "website",
    url: "https://1000freetools.com/math-tools/eigenvalue-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/eigenvalue-calculator">Eigenvalue Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Digit Sum Calculator – Find Sum of Digits of Any Number",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/digit-sum-calculator",
  },
  openGraph: {
    title: "Digit Sum Calculator – Find Sum of Digits of Any Number",
    description: "Calculate the sum of all digits in any number with our free online digit sum calculator. Also computes the digital root through repeated digit summation.",
    type: "website",
    url: "https://1000freetools.com/math-tools/digit-sum-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/digit-sum-calculator">Digit Sum Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

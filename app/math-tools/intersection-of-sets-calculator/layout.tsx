...
export const metadata: Metadata = {
  title: "Intersection of Sets Calculator – Find A ∩ B Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/intersection-of-sets-calculator",
  },
  openGraph: {
    title: "Intersection of Sets Calculator – Find A ∩ B Online",
    description: "Find the intersection of any two or more sets with our free online intersection calculator. Identifies all common elements shared between sets with clear notation.",
    type: "website",
    url: "https://1000freetools.com/math-tools/intersection-of-sets-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/intersection-of-sets-calculator">Intersection Of Sets Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

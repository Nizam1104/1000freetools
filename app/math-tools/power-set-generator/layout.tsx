...
export const metadata: Metadata = {
  title: "Power Set Generator – Find All Subsets of a Set Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/power-set-generator",
  },
  openGraph: {
    title: "Power Set Generator – Find All Subsets of a Set Online",
    description: "Generate the complete power set (all subsets) of any set with our free online power set generator. Lists every possible subset from empty set to the complete set.",
    type: "website",
    url: "https://1000freetools.com/math-tools/power-set-generator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/power-set-generator">Power Set Generator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/temperature-converter",
  },
  openGraph: {
    title: "Temperature Converter – Celsius to Fahrenheit & Kelvin",
    description: "Convert temperatures between Celsius, Fahrenheit, and Kelvin instantly with our free online temperature converter. Get accurate conversions with the formula used shown clearly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/temperature-converter",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/temperature-converter">Temperature Converter</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

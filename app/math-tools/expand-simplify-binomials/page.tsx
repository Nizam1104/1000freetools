    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <section className="mb-12 border-t pt-8">
          <h2 className="text-2xl font-semibold mb-6">Binomial Expansion Formulas</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-3">Square of a Binomial</h3>
              <p className="text-sm font-mono mb-2">(a + b)² = a² + 2ab + b²</p>
              <p className="text-sm font-mono">(a - b)² = a² - 2ab + b²</p>
              <p className="text-xs text-muted-foreground mt-2">The square of a sum/difference equals the square of the first term, plus/minus twice the product, plus the square of the second term.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-3">Cube of a Binomial</h3>
              <p className="text-sm font-mono mb-2">(a + b)³ = a³ + 3a²b + 3ab² + b³</p>
              <p className="text-sm font-mono">(a - b)³ = a³ - 3a²b + 3ab² - b³</p>
              <p className="text-xs text-muted-foreground mt-2">The cube expands to four terms with coefficients 1, 3, 3, 1 (from Pascal's triangle).</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-3">Product of Binomials (FOIL)</h3>
              <p className="text-sm font-mono mb-2">(a + b)(c + d) = ac + ad + bc + bd</p>
              <p className="text-xs text-muted-foreground mt-2">FOIL stands for: First, Outer, Inner, Last – the order of multiplying terms.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-3">Difference of Squares</h3>
              <p className="text-sm font-mono mb-2">(a + b)(a - b) = a² - b²</p>
              <p className="text-xs text-muted-foreground mt-2">The product of a sum and difference equals the difference of squares.</p>
            </div>
          </div>
        </section>

        <section className="mb-12 border-t pt-8">
          <h2 className="text-2xl font-semibold mb-6">Why Use This Binomial Calculator?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Multiple Operations</h3>
              <p className="text-sm text-muted-foreground">Handles squares, cubes, products, and difference of squares.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Step-by-Step</h3>
              <p className="text-sm text-muted-foreground">Shows each step of the expansion process clearly.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Variable Support</h3>
              <p className="text-sm text-muted-foreground">Works with numbers, variables, and coefficients.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Educational Tool</h3>
              <p className="text-sm text-muted-foreground">Learn FOIL method and binomial formulas with examples.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 border-t pt-8">
          ...
          <div className="space-y-4">
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Example 1: Square of a Binomial</h3>
              <p className="text-sm font-mono mb-2">(x + 3)²</p>
              <p className="text-sm text-muted-foreground">= x² + 2(x)(3) + 3²</p>
              <p className="text-sm text-muted-foreground">= x² + 6x + 9</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Example 2: Cube of a Binomial</h3>
              <p className="text-sm font-mono mb-2">(x + 2)³</p>
              <p className="text-sm text-muted-foreground">= x³ + 3(x²)(2) + 3(x)(2²) + 2³</p>
              <p className="text-sm text-muted-foreground">= x³ + 6x² + 12x + 8</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Example 3: FOIL Method</h3>
              <p className="text-sm font-mono mb-2">(x + 4)(x - 2)</p>
              <p className="text-sm text-muted-foreground">First: x × x = x²</p>
              <p className="text-sm text-muted-foreground">Outer: x × (-2) = -2x</p>
              <p className="text-sm text-muted-foreground">Inner: 4 × x = 4x</p>
              <p className="text-sm text-muted-foreground">Last: 4 × (-2) = -8</p>
              <p className="text-sm text-muted-foreground">Combine: x² - 2x + 4x - 8 = x² + 2x - 8</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">Example 4: Difference of Squares</h3>
              <p className="text-sm font-mono mb-2">(x + 5)(x - 5)</p>
              <p className="text-sm text-muted-foreground">= x² - 5²</p>
              <p className="text-sm text-muted-foreground">= x² - 25</p>
            </div>
          </div>
        </section>

        <section className="mb-12 border-t pt-8">
          <h2 className="text-2xl font-semibold mb-6">The FOIL Method</h2>
          <div className="p-5 bg-muted rounded-lg">
            <p className="text-sm text-muted-foreground mb-4">
              FOIL is a mnemonic for multiplying two binomials. It stands for:
            </p>
            <div className="grid md:grid-cols-4 gap-4">
              <div className="bg-background p-3 rounded-md">
                <p className="font-semibold text-primary mb-1">F - First</p>
                <p className="text-xs text-muted-foreground">Multiply the first terms of each binomial</p>
              </div>
              <div className="bg-background p-3 rounded-md">
                <p className="font-semibold text-primary mb-1">O - Outer</p>
                <p className="text-xs text-muted-foreground">Multiply the outer terms</p>
              </div>
              <div className="bg-background p-3 rounded-md">
                <p className="font-semibold text-primary mb-1">I - Inner</p>
                <p className="text-xs text-muted-foreground">Multiply the inner terms</p>
              </div>
              <div className="bg-background p-3 rounded-md">
                <p className="font-semibold text-primary mb-1">L - Last</p>
                <p className="text-xs text-muted-foreground">Multiply the last terms of each binomial</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 border-t pt-8">
          ...
          <div className="space-y-4">
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">What is a binomial?</h3>
              <p className="text-sm text-muted-foreground">A binomial is a polynomial with exactly two terms, such as x + 3 or 2a - 5b. The terms are separated by addition or subtraction.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">What does it mean to expand a binomial?</h3>
              <p className="text-sm text-muted-foreground">Expanding means multiplying out the binomial expression to write it as a sum of individual terms without parentheses.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">What is the FOIL method?</h3>
              <p className="text-sm text-muted-foreground">FOIL is a method for multiplying two binomials: First, Outer, Inner, Last. Multiply corresponding terms and add the results.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">What is Pascal's triangle?</h3>
              <p className="text-sm text-muted-foreground">Pascal's triangle gives the coefficients for binomial expansions. Row 2 (1,2,1) is for squares, row 3 (1,3,3,1) is for cubes.</p>
            </div>
            <div className="p-5 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2">How do you simplify after expanding?</h3>
              <p className="text-sm text-muted-foreground">Combine like terms – terms with the same variables raised to the same powers. Add or subtract their coefficients.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 border-t pt-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <a href="/math-tools/simplify-expression" className="p-5 bg-muted rounded-lg hover:border-primary transition-colors border">
              <h3 className="font-semibold mb-2">Simplify Expression</h3>
              <p className="text-sm text-muted-foreground">Combine like terms in expressions.</p>
            </a>

...
export const metadata: Metadata = {
  title: "Annuity Calculator – Compute Annuity Payments Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/annuity-calculator",
  },
  openGraph: {
    title: "Annuity Calculator – Compute Annuity Payments Online",
    description: "Calculate annuity payments, present value, or future value with our free online annuity calculator. Covers ordinary annuities and annuities due with complete financial breakdowns.",
    type: "website",
    url: "https://1000freetools.com/math-tools/annuity-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/annuity-calculator">Annuity Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

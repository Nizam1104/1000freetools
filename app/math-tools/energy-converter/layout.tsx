...
export const metadata: Metadata = {
  title: "Energy Converter – Convert Joules, Calories, kWh Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/energy-converter",
  },
  openGraph: {
    title: "Energy Converter – Convert Joules, Calories, kWh Online",
    description: "Convert between any energy unit with our free online energy converter. Supports joules, calories, kilocalories, kilowatt-hours, BTU, and more for science and engineering.",
    type: "website",
    url: "https://1000freetools.com/math-tools/energy-converter",
...
const tools = [
  ...
  {
    "name": "Pressure Converter – Convert Pascal, Bar, PSI, ATM Online",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/energy-converter">Energy Converter</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

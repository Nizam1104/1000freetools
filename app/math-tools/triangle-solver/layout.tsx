...
export const metadata: Metadata = {
  title: "Triangle Solver – Solve Any Triangle SSS SAS ASA AAS",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/triangle-solver",
  },
  openGraph: {
    title: "Triangle Solver – Solve Any Triangle SSS SAS ASA AAS",
    description: "Solve any triangle completely using SSS, SAS, ASA, or AAS methods with our free online triangle solver. Find all missing sides, angles, and area with step-by-step trigonometric solutions.",
    type: "website",
    url: "https://1000freetools.com/math-tools/triangle-solver",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/triangle-solver">Triangle Solver</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

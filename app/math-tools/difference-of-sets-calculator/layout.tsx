...
export const metadata: Metadata = {
  title: "Set Difference Calculator – Find A − B Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/difference-of-sets-calculator",
  },
  openGraph: {
    title: "Set Difference Calculator – Find A − B Online",
    description: "Calculate the difference between any two sets with our free online set difference calculator. Find all elements that are in set A but not in set B instantly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/difference-of-sets-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/difference-of-sets-calculator">Difference Of Sets Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

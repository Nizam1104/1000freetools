...
export const metadata: Metadata = {
  title: "Binary Addition & Subtraction Calculator – Compute in Base 2",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/binary-arithmetic-calculator",
  },
  openGraph: {
    title: "Binary Addition & Subtraction Calculator – Compute in Base 2",
    description: "Add and subtract binary numbers step by step with our free online binary calculator. See each bit-by-bit operation clearly – perfect for computer science and digital electronics.",
    type: "website",
    url: "https://1000freetools.com/math-tools/binary-arithmetic-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/binary-arithmetic-calculator">Binary Arithmetic Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Scalar Matrix Multiplication Calculator – Multiply Matrix by Scalar",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/scalar-multiplication-calculator",
  },
  openGraph: {
    title: "Scalar Matrix Multiplication Calculator – Multiply Matrix by Scalar",
    description: "Multiply any matrix by a scalar constant with our free online scalar multiplication calculator. See the scaled matrix with all element-by-element calculations shown clearly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/scalar-multiplication-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/scalar-multiplication-calculator">Scalar Multiplication Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">Scalar Multiplication</h2>
        <p className="text-muted-foreground">
          Scalar multiplication is the operation of multiplying a matrix by a scalar (a single number). Each element of the matrix is multiplied by the scalar, producing a new matrix of the same dimensions.
        </p>
        <p className="text-muted-foreground">
          If A is an m×n matrix and k is a scalar, then kA is also an m×n matrix where each element (kA)ᵢⱼ = k × Aᵢⱼ.
        </p>
      </section>

      <section className="border-t pt-8">
        <h2 className="text-2xl font-semibold mb-6">Scalar Multiplication Formula</h2>
        <div className="p-4 border rounded-lg">
...
3 ×  [3, 4]]   =   [3×3, 3×4]]  =  [9, 12]]`}
      ...
      <section className="border-t pt-8">
        <h2 className="text-2xl font-semibold mb-6">Properties of Scalar Multiplication</h2>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">Basic Properties</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• 1 × A = A (identity scalar)</li>
              <li>• 0 × A = 0 (zero matrix)</li>
              <li>• (-1) × A = -A (negative matrix)</li>
              <li>• c(A + B) = cA + cB (distributive over matrix addition)</li>
              <li>• (c + d)A = cA + dA (distributive over scalar addition)</li>
            </ul>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">Associative Properties</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• (cd)A = c(dA) (associative with scalars)</li>
      ...
      <section className="border-t pt-8">
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Positive Scalar</h3>
...
= [[2, 4, 6],
   [8, 10, 12]]`}
          ...
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Negative Scalar</h3>
            <code className="text-sm font-mono bg-muted px-2 py-1 rounded block">
              {`-1 × [[3, 1],
      [2, 4]]
...
= [[-3, -1],
   [-2, -4]]`}
          ...
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Fractional Scalar</h3>
            <code className="text-sm font-mono bg-muted px-2 py-1 rounded block">
              {`0.5 × [[4, 6],
      [8, 10]]
...
= [[2, 3],
   [4, 5]]`}
      ...
      <section className="border-t pt-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 border rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              Scaling transformations use scalar multiplication to resize objects uniformly.
            </p>
          </div>
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Physics</h3>
            <p className="text-sm text-muted-foreground">
              Scaling vectors and tensors by physical constants or unit conversions.
            </p>
          </div>
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Data Normalization</h3>
            <p className="text-sm text-muted-foreground">
              Scaling data matrices for machine learning preprocessing.
            </p>
          </div>
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Economics</h3>
            <p className="text-sm text-muted-foreground">
              Scaling input-output matrices for different production levels.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">What is a scalar?</h3>
            <p className="text-sm text-muted-foreground">
              A scalar is a single number (real or complex) as opposed to a vector or matrix. Scalars represent magnitude without direction.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">Does scalar multiplication change matrix dimensions?</h3>
            <p className="text-sm text-muted-foreground">
              No, the resulting matrix has exactly the same dimensions as the original matrix.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">What happens when multiplying by zero?</h3>
            <p className="text-sm text-muted-foreground">
              Multiplying any matrix by 0 produces a zero matrix (all elements become 0).
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">Can I multiply by a negative scalar?</h3>
            <p className="text-sm text-muted-foreground">
              Yes! Negative scalars flip the sign of every element in the matrix.
            </p>
          </div>
        </div>
      </section>

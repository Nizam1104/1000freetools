...
export const metadata: Metadata = {
  title: "Correlation Coefficient Calculator – Find Pearson r Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/correlation-coefficient-calculator",
  },
  openGraph: {
    title: "Correlation Coefficient Calculator – Find Pearson r Online",
    description: "Calculate the Pearson correlation coefficient between two variables with our free online calculator. Measure the strength and direction of linear relationships in your data.",
    type: "website",
    url: "https://1000freetools.com/math-tools/correlation-coefficient-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/correlation-coefficient-calculator">Correlation Coefficient Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

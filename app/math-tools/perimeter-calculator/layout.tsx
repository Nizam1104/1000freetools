...
export const metadata: Metadata = {
  title: "Perimeter Calculator – Find Perimeter of Any Shape Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/perimeter-calculator",
  },
  openGraph: {
    title: "Perimeter Calculator – Find Perimeter of Any Shape Online",
    description: "Calculate the perimeter of any 2D shape with our free online perimeter calculator. Covers rectangles, triangles, circles, polygons, and more with step-by-step solutions.",
    type: "website",
    url: "https://1000freetools.com/math-tools/perimeter-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/perimeter-calculator">Perimeter Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

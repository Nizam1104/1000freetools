  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          The Cartesian coordinate plane consists of two perpendicular number lines: the horizontal x-axis and vertical y-axis. They intersect at the origin (0, 0) and divide the plane into four quadrants.
        </p>
        <div className="grid md:grid-cols-4 gap-4">
          <div className="p-4 bg-muted rounded-lg text-center">
            <h3 className="font-semibold text-sm mb-2">Quadrant I</h3>
            <p className="text-sm text-muted-foreground">(+, +)</p>
            <p className="text-xs text-muted-foreground">Top right</p>
          </div>
          <div className="p-4 bg-muted rounded-lg text-center">
            <h3 className="font-semibold text-sm mb-2">Quadrant II</h3>
            <p className="text-sm text-muted-foreground">(-, +)</p>
            <p className="text-xs text-muted-foreground">Top left</p>
          </div>
          <div className="p-4 bg-muted rounded-lg text-center">
            <h3 className="font-semibold text-sm mb-2">Quadrant III</h3>
            <p className="text-sm text-muted-foreground">(-, -)</p>
            <p className="text-xs text-muted-foreground">Bottom left</p>
          </div>
          <div className="p-4 bg-muted rounded-lg text-center">
            <h3 className="font-semibold text-sm mb-2">Quadrant IV</h3>
            <p className="text-sm text-muted-foreground">(+, -)</p>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">What is a coordinate plane?</h3>
          <p className="text-sm text-muted-foreground">
            A coordinate plane is a 2D grid formed by two perpendicular number lines. Each point is identified by an ordered pair (x, y) showing its horizontal and vertical position.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do I plot a point?</h3>
          <p className="text-sm text-muted-foreground">
            Start at the origin. Move horizontally by the x-value (right for positive, left for negative), then vertically by the y-value (up for positive, down for negative).
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What is the origin?</h3>
          <p className="text-sm text-muted-foreground">
            The origin is the point (0, 0) where the x-axis and y-axis intersect. It's the reference point for all other coordinates.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can I plot negative coordinates?</h3>
          <p className="text-sm text-muted-foreground">
            Yes! Negative x values go left of the y-axis, and negative y values go below the x-axis.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What are coordinates used for?</h3>
          <p className="text-sm text-muted-foreground">
            Coordinates are used in graphing functions, geometry, navigation (GPS), computer graphics, physics, and any field requiring spatial representation.
          </p>
        </div>
      </section>

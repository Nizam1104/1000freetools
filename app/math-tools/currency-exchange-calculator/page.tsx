  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          Currency exchange is the process of converting one country's currency into another. Exchange rates fluctuate based on economic factors, interest rates, inflation, and market demand.
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Base Currency</h3>
            <p className="text-sm text-muted-foreground">
              The currency you're converting FROM. In this calculator, all rates are relative to USD as the base.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Quote Currency</h3>
            <p className="text-sm text-muted-foreground">
              The currency you're converting TO. The exchange rate shows how much of this currency you receive.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Exchange Rate</h3>
            <p className="text-sm text-muted-foreground">
              The ratio between two currencies. A rate of 0.92 EUR/USD means 1 USD equals 0.92 Euros.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">Major World Currencies</h2>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Most Traded Currencies</h3>
          ...
          <div className="p-4 border rounded-lg">
            ...
            <ul className="space-y-1 text-sm">
              <li>$ - Dollar (USD, CAD, AUD, etc.)</li>
              <li>€ - Euro (EUR)</li>
              <li>£ - Pound (GBP)</li>
              <li>¥ - Yen/Yuan (JPY, CNY)</li>
              <li>₹ - Rupee (INR)</li>
            </ul>
          </div>
        </div>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">How do exchange rates work?</h3>
          <p className="text-sm text-muted-foreground">
            Exchange rates show the value of one currency relative to another. If EUR/USD = 0.92, one US dollar buys 0.92 euros. Rates change constantly in forex markets.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Why do exchange rates vary?</h3>
          <p className="text-sm text-muted-foreground">
            Rates fluctuate due to interest rates, inflation, economic performance, political stability, trade balances, and market speculation.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What is the strongest currency?</h3>
          <p className="text-sm text-muted-foreground">
            The Kuwaiti Dinar (KWD) is typically the strongest, followed by Bahraini Dinar and Omani Rial. Strength is measured by value relative to USD.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">When should I exchange currency?</h3>
          <p className="text-sm text-muted-foreground">
            Monitor rates before travel or large transactions. Consider exchanging when your home currency is strong relative to the destination currency.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Are these rates real-time?</h3>
          <p className="text-sm text-muted-foreground">
            No, these are static reference rates. For actual transactions, check with banks, exchange services, or financial platforms for live rates.
          </p>
        </div>
      </section>

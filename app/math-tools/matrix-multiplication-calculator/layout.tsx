...
export const metadata: Metadata = {
  title: "Matrix Multiplication Calculator – Multiply Matrices Online",
  ...
  openGraph: {
    ...
    description: "Multiply any two compatible matrices with our free online matrix multiplication calculator. See the full product matrix with step-by-step row-by-column computation.",
    type: "website",
    url: "https://1000freetools.com/math-tools/matrix-multiplication-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/matrix-multiplication-calculator">Matrix Multiplication Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

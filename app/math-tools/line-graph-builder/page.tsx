  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          A line graph displays data points connected by straight line segments. It's ideal for showing trends over time, comparing changes across categories, and visualizing continuous data.
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">When to Use</h3>
            <p className="text-sm text-muted-foreground">
              Track changes over time, show trends, compare multiple data series, or visualize continuous measurements.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Best Practices</h3>
            <p className="text-sm text-muted-foreground">
              Start y-axis at zero (usually), use consistent intervals, limit data series to 4-5, and label clearly.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Interpreting Trends</h3>
            <p className="text-sm text-muted-foreground">
              Upward slope = increase, downward slope = decrease, flat line = no change. Steeper slopes indicate faster changes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">What is a line graph used for?</h3>
          <p className="text-sm text-muted-foreground">
            Line graphs are used to display data that changes over time. They're perfect for showing stock prices, temperature changes, sales trends, or any time-series data.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do I read a line graph?</h3>
          <p className="text-sm text-muted-foreground">
            Follow the line from left to right. Rising sections show increases, falling sections show decreases. The steeper the line, the faster the change.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What's the difference between line and bar charts?</h3>
          <p className="text-sm text-muted-foreground">
            Line charts show trends over continuous data (like time). Bar charts compare discrete categories. Use lines for trends, bars for comparisons.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can line graphs have multiple lines?</h3>
          <p className="text-sm text-muted-foreground">
            Yes! Multiple lines can compare different data series. Use different colors and include a legend to distinguish them.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What does a smooth line mean?</h3>
          <p className="text-sm text-muted-foreground">
            A smooth line uses curves instead of sharp angles between points. It suggests continuous change and can make trends easier to see.
          </p>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          <a href="/math-tools/scatter-plot-generator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            <p className="font-semibold text-sm">Scatter Plot Generator</p>
            <p className="text-xs text-muted-foreground">Scatter plots</p>
          </a>
        </div>
      </section>
    </div>

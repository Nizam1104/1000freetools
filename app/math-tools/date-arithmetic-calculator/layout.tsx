...
export const metadata: Metadata = {
  title: "Date Arithmetic Calculator – Add or Subtract Days from a Date",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/date-arithmetic-calculator",
  },
  openGraph: {
    title: "Date Arithmetic Calculator – Add or Subtract Days from a Date",
    description: "Add or subtract days, weeks, or months from any date with our free online date arithmetic calculator. Find past and future dates from any starting date instantly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/date-arithmetic-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/date-arithmetic-calculator">Date Arithmetic Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

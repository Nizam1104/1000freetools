...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/day-of-week-calculator",
  },
  openGraph: {
    title: "Day of the Week Calculator – Find What Day Any Date Falls On",
    description: "Find out what day of the week any past, present, or future date falls on with our free online day of the week calculator. Works for any date in history.",
    type: "website",
    url: "https://1000freetools.com/math-tools/day-of-week-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/day-of-week-calculator">Day Of Week Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Boolean Expression Evaluator – Evaluate Logic Expressions Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/boolean-expression-evaluator",
  },
  openGraph: {
    title: "Boolean Expression Evaluator – Evaluate Logic Expressions Online",
    description: "Evaluate any Boolean expression for given variable values with our free online Boolean expression evaluator. Supports all logical operators including AND, OR, NOT, XOR, and more.",
    type: "website",
    url: "https://1000freetools.com/math-tools/boolean-expression-evaluator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/boolean-expression-evaluator">Boolean Expression Evaluator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Subset Checker – Check if A is a Subset of B Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/subset-checker",
  },
  openGraph: {
    title: "Subset Checker – Check if A is a Subset of B Online",
    description: "Check whether a set is a subset or proper subset of another set with our free online subset checker. Instantly verify set containment relationships with clear explanations.",
    type: "website",
    url: "https://1000freetools.com/math-tools/subset-checker",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/subset-checker">Subset Checker</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

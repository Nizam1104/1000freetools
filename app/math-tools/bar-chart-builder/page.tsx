  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">Understanding Bar Charts</h2>
        <p className="text-muted-foreground">
          A bar chart uses rectangular bars to represent data values. The length of each bar is proportional to the value it represents. Bar charts are ideal for comparing quantities across different categories or tracking changes over time.
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">When to Use</h3>
            <p className="text-sm text-muted-foreground">
              Compare values across categories, show rankings, display discrete data, or visualize survey results.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Vertical vs Horizontal</h3>
            <p className="text-sm text-muted-foreground">
              Vertical bars (column charts) work well for time series. Horizontal bars are better for long category names.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Best Practices</h3>
            <p className="text-sm text-muted-foreground">
              Start y-axis at zero, use consistent colors, limit categories to 10 or fewer, and order data logically.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-6">
        ...
        <div>
          <h3 className="font-semibold mb-2">What is a bar chart used for?</h3>
          <p className="text-sm text-muted-foreground">
            Bar charts are used to compare values across different categories. They're perfect for showing sales by product, population by country, or scores by team.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How do I read a bar chart?</h3>
          <p className="text-sm text-muted-foreground">
            Look at the length of each bar relative to the axis scale. Longer bars represent larger values. Compare bars to see which categories have higher or lower values.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">Can bar charts show negative values?</h3>
          <p className="text-sm text-muted-foreground">
            Yes! Negative values extend below the x-axis. This is useful for showing losses, deficits, or decreases.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">What's the difference between bar and column charts?</h3>
          <p className="text-sm text-muted-foreground">
            They're the same concept. "Bar chart" typically means horizontal bars, while "column chart" means vertical bars. This tool creates vertical column charts.
          </p>
        </div>
        <div>
          <h3 className="font-semibold mb-2">How many categories should I include?</h3>
          <p className="text-sm text-muted-foreground">
            For clarity, limit bar charts to 10 or fewer categories. For more categories, consider grouping or using a different visualization like a table.
          </p>
        </div>
      </section>
      ...
      <section className="border-t pt-8 space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          <a href="/math-tools/line-graph-builder" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            <p className="font-semibold text-sm">Line Graph Builder</p>
            <p className="text-xs text-muted-foreground">Create line graphs</p>
          </a>
          <a href="/math-tools/histogram-generator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Distribution charts</p>
          </a>
        </div>
      </section>
    </div>

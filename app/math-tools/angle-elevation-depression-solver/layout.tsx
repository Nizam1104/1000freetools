...
export const metadata: Metadata = {
  title: "Angle of Elevation & Depression Calculator – Solve Word Problems",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/angle-elevation-depression-solver",
  },
  openGraph: {
    title: "Angle of Elevation & Depression Calculator – Solve Word Problems",
    description: "Calculate the angle of elevation or depression with our free online solver. Enter height and distance to find the angle, or the angle to find missing dimensions – perfect for trig word problems.",
    type: "website",
    url: "https://1000freetools.com/math-tools/angle-elevation-depression-solver",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/angle-elevation-depression-solver">Angle Elevation Depression Solver</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

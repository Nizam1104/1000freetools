...
export const metadata: Metadata = {
  title: "Distance Between Two Points Calculator – Find Distance Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/distance-between-two-points-calculator",
  },
  openGraph: {
    title: "Distance Between Two Points Calculator – Find Distance Online",
    description: "Find the distance between any two points on a coordinate plane using our free online distance formula calculator. Supports 2D and 3D coordinates with instant accurate results.",
    type: "website",
    url: "https://1000freetools.com/math-tools/distance-between-two-points-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/distance-between-two-points-calculator">Distance Between Two Points Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

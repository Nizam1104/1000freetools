...
export const metadata: Metadata = {
  title: "Matrix Rank Calculator – Find Rank of Any Matrix Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/matrix-rank-calculator",
  },
  openGraph: {
    title: "Matrix Rank Calculator – Find Rank of Any Matrix Online",
    description: "Find the rank of any matrix with our free online matrix rank calculator. Uses row reduction to row echelon form with step-by-step working shown for complete understanding.",
    type: "website",
    url: "https://1000freetools.com/math-tools/matrix-rank-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/matrix-rank-calculator">Matrix Rank Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

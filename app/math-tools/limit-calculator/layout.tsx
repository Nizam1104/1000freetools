...
export const metadata: Metadata = {
  title: "Limit Calculator – Evaluate Limits of Functions Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/limit-calculator",
  },
  openGraph: {
    title: "Limit Calculator – Evaluate Limits of Functions Online",
    description: "Calculate limits of any function as x approaches a value or infinity with our free online limit calculator. Evaluates one-sided and two-sided limits with clear results.",
    type: "website",
    url: "https://1000freetools.com/math-tools/limit-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/limit-calculator">Limit Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Normal Distribution Calculator – Find Probability & Percentile",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/normal-distribution-calculator",
  },
  openGraph: {
    title: "Normal Distribution Calculator – Find Probability & Percentile",
    description: "Calculate probabilities and percentiles for a normal distribution with our free online calculator. Input mean and standard deviation to find area under the bell curve.",
    type: "website",
    url: "https://1000freetools.com/math-tools/normal-distribution-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/normal-distribution-calculator">Normal Distribution Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

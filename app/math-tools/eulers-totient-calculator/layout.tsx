...
export const metadata: Metadata = {
  title: "Euler's Totient Function Calculator – Compute φ(n) Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/eulers-totient-calculator",
  },
  openGraph: {
    title: "Euler's Totient Function Calculator – Compute φ(n) Online",
    description: "Calculate Euler's totient function φ(n) for any integer with our free online calculator. Find the count of integers up to n that share no common factor with n.",
    type: "website",
    url: "https://1000freetools.com/math-tools/eulers-totient-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/eulers-totient-calculator">Eulers Totient Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Harmonic Mean Calculator – Find Harmonic Average Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/harmonic-mean-calculator",
  },
  openGraph: {
    title: "Harmonic Mean Calculator – Find Harmonic Average Online",
    description: "Calculate the harmonic mean of any dataset with our free online harmonic mean calculator. Ideal for rates and ratios where harmonic averaging is more appropriate.",
    type: "website",
    url: "https://1000freetools.com/math-tools/harmonic-mean-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/harmonic-mean-calculator">Harmonic Mean Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Identity Matrix Generator – Create n×n Identity Matrix",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/identity-matrix-generator",
  },
  openGraph: {
    title: "Identity Matrix Generator – Create n×n Identity Matrix",
    description: "Generate an identity matrix of any size instantly with our free online identity matrix generator. Create n×n identity matrices for linear algebra, matrix operations, and proofs.",
    type: "website",
    url: "https://1000freetools.com/math-tools/identity-matrix-generator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/identity-matrix-generator">Identity Matrix Generator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "nth Term Finder – Find Any Term of a Sequence Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/nth-term-finder",
  },
  openGraph: {
    title: "nth Term Finder – Find Any Term of a Sequence Online",
    description: "Find the nth term of any arithmetic or geometric sequence with our free online nth term finder. Enter sequence parameters to calculate any specific term instantly.",
    type: "website",
    url: "https://1000freetools.com/math-tools/nth-term-finder",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/nth-term-finder">Nth Term Finder</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Confidence Interval Calculator – Find CI for Mean Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/confidence-interval-calculator",
  },
  openGraph: {
    title: "Confidence Interval Calculator – Find CI for Mean Online",
    description: "Calculate confidence intervals for population means with our free online confidence interval calculator. Supports 90%, 95%, and 99% confidence levels with margin of error shown.",
    type: "website",
    url: "https://1000freetools.com/math-tools/confidence-interval-calculator",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/confidence-interval-calculator">Confidence Interval Calculator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

...
export const metadata: Metadata = {
  title: "Frequency Distribution Table Generator – Organize Data Online",
  ...
  alternates: {
    canonical: "https://1000freetools.com/math-tools/frequency-distribution-table",
  },
  openGraph: {
    title: "Frequency Distribution Table Generator – Organize Data Online",
    description: "Create a complete frequency distribution table from any dataset with our free online tool. Includes frequency, relative frequency, and cumulative frequency for easy data analysis.",
    type: "website",
    url: "https://1000freetools.com/math-tools/frequency-distribution-table",
      ...
      <div>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/math-tools/frequency-distribution-table">Frequency Distribution Table</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>

  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <section className="border-t pt-8 space-y-4">
        <h2 className="text-2xl font-semibold">What is Future Value?</h2>
        <p className="text-muted-foreground">
          Future Value (FV) is the value of a current asset or investment at a specified date in the future, based on an assumed rate of growth. It helps you understand how much your money will be worth after earning interest over time.
        </p>
        <p className="text-muted-foreground">
          Future value calculations are essential for retirement planning, investment analysis, savings goals, and comparing different investment options. The power of compound interest means your money grows faster over time as interest earns interest.
        </p>
      </section>

      <section className="border-t pt-8">
        <h2 className="text-2xl font-semibold mb-6">Future Value Formula</h2>
        <div className="p-4 border rounded-lg">
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-lg">
            ...
            <code className="text-sm font-mono bg-muted px-2 py-1 rounded block">
              FV = 10000 × (1 + 0.07/12)^(12×30)<br />
              FV = $81,164.98<br />
              Interest earned: $71,164.98
            </code>
          </div>
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">College Fund</h3>
            <p className="text-sm text-muted-foreground mb-2">
              Save $25,000 at 5% compounded quarterly for 18 years
            </p>
            <code className="text-sm font-mono bg-muted px-2 py-1 rounded block">
              FV = 25000 × (1 + 0.05/4)^(4×18)<br />
              FV = $61,237.54<br />
              Interest earned: $36,237.54
            </code>
          </div>
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">Emergency Fund</h3>
            <p className="text-sm text-muted-foreground mb-2">
              Deposit $5,000 at 4% compounded daily for 5 years
            </p>
            <code className="text-sm font-mono bg-muted px-2 py-1 rounded block">
              FV = 5000 × (1 + 0.04/365)^(365×5)<br />
              FV = $6,106.97<br />
              Interest earned: $1,106.97
            </code>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">How does compounding frequency affect future value?</h3>
            <p className="text-sm text-muted-foreground">
              More frequent compounding produces higher future values. Daily compounding earns slightly more than monthly, which earns more than annual. The difference grows with larger amounts and longer time periods.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">What's the difference between FV and PV?</h3>
            <p className="text-sm text-muted-foreground">
              Present Value (PV) is what money is worth today. Future Value (FV) is what it will be worth later after earning interest. FV is always greater than PV when interest rates are positive.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">How can I increase my investment's future value?</h3>
            <p className="text-sm text-muted-foreground">
              Start earlier (more time), invest more (higher PV), find better rates (higher r), or choose more frequent compounding. Time is the most powerful factor due to exponential growth.
            </p>
          </div>
          <div className="p-4 bg-muted rounded-lg">
            <h3 className="font-semibold mb-2">Does future value account for inflation?</h3>
            <p className="text-sm text-muted-foreground">
              No, this calculator shows nominal future value. To find real purchasing power, subtract inflation from your return rate. For example, 7% return minus 3% inflation = 4% real return.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t pt-8">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <a href="/math-tools/present-value-calculator" className="p-4 rounded-lg border hover:bg-muted transition-colors">
            ...
            <p className="text-xs text-muted-foreground">Discount future cash</p>
          </a>

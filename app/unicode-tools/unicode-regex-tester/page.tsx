...
export const metadata: Metadata = {
  ...
  description: `Test regular expressions with full Unicode support. Use Unicode property escapes, script matching, and real-time highlighting. Free regex tester.`,
  alternates: {
    canonical: `https://1000freetools.com/unicode-tools/unicode-regex-tester`,
  },
};
...
export default function UnicodeRegexTesterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-3">Unicode Regex Tester</h1>
        <p className="text-muted-foreground">Write and test regular expressions that work correctly with Unicode. Use Unicode property escapes and script matching to validate text patterns.</p>
      </header>

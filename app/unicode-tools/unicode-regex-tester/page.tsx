    ...
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">
          Write and test regular expressions that work correctly with Unicode.
          Use Unicode property escapes and script matching to validate text
          patterns.
        </p>
      </header>
      {<UnicodeRegexTester />}
      <UnicodeRegexTesterSeo />

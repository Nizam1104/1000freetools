...
import UnicodeBidirectionalEditorSeo from "@/components/seo-content/unicode-tools/unicode-bidirectional-editor";

export const metadata: Metadata = {
  title: `Unicode Bidirectional Text Editor | LTR RTL Mix`,
  description: `Edit bidirectional Unicode text. Insert directional formatting characters and visualize LTR/RTL mixing. Essential for Arabic, Hebrew, and mixed scripts.`,
  alternates: {
    canonical: `https://1000freetools.com/unicode-tools/unicode-bidirectional-editor`,
  },
};
...
export default function UnicodeBidirectionalEditorPage() {
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">
          Edit text containing both left-to-right and right-to-left scripts.
          Visualize and control text direction with Unicode formatting
          characters.
        </p>
      </header>
      <div className="mt-8">

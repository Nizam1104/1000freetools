...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://1000freetools.com/encoding-tools/bcd-binary-coded-decimal-converter`,
  },
};
...
export default function BcdBinaryCodedDecimalConverterPage() {
  return (
    <div className="flex flex-col gap-y-4">
      ...
      {/* TODO: add tool component for bcd-binary-coded-decimal-converter */}
      {/* TODO: add seo component for bcd-binary-coded-decimal-converter */}

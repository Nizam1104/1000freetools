  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">Convert text from EBCDIC encoding (used in mainframe systems) to ASCII, or from ASCII to EBCDIC. This tool supports multiple EBCDIC code pages for legacy system compatibility.</p>
      </header>

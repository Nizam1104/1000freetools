...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://1000freetools.com/encoding-tools/utf7-encoder-decoder`,
  },
};
  ...
  return (
    <div className="flex flex-col gap-y-4">
      <header className="max-w-3xl">
        ...
        <p className="text-muted-foreground">Convert text to and from UTF-7 encoding, a legacy format for representing Unicode in ASCII-compatible 7-bit systems. Mainly used for historical or compatibility testing.</p>
      </header>
      {/* TODO: add tool component for utf7-encoder-decoder */}
